...
namespace FrameWorks.Makes.System3090
{
    ...
    public class FixeDblMitr : SubAssemblyBase
    {
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(4344, "BrzFixedIGVert", this, 1, m_subAssemblyHieght);
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(4344, "BrzFixedIGHorz", this, 1, m_subAssemblyWidth);
                part.PartGroupType = "FrameBrz-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
            ...
            for (int i = 0; i < 4; i++)
            {
                part = new Part(4344, "BrzFixedIGHorz", this, 1, m_subAssemblyDepth);
                part.PartGroupType = "FrameBrz-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
                part.PartLabel = "SEE_DWG";
