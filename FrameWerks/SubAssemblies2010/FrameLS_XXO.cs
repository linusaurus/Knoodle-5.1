...
namespace FrameWorks.Makes.System2010
{
    ...
    public class FrameLS_XXO : SubAssemblyBase
    {
        ...
        public override void Build()
        {
            ...
            //TopTrackX
            Component = new Component(3406, "TopTrackX", this, 1, (trackHelper.DoorPanelWidth * 2.0m) - stileOverLap + doorGap + uniTrackAdd);
            ...
            //TopTrackXX
            Component = new Component(3406, "TopTrackXX", this, 1, ((trackHelper.DoorPanelWidth * 3.0m) - stileOvrLpX2) + doorGap );
            Component.ComponentGroupType = "TopTrackY-Components";
            Component.ComponentLabel = "";
            ...
            // TopTrackO
            Component = new Component(3406, "TopTrackO", this, 1, (trackHelper.DoorPanelWidth) + doorGap + yTrAccess );
            Component.ComponentGroupType = "TopTrackY-Components";
            Component.ComponentLabel = "";
            ...
            // FaciaHeadIntXXX_4 ^^
            Component = new Component(4362, "FaciaHeadIntXXX_4", this, 1, m_subAssemblyWidth - jambDimW + doorGap - jambInset);
            Component.ComponentGroupType = "Frame-Components";
            Component.ComponentLabel = "";
            ...
            // FaciaHeadExtO_1 ^^
            Component = new Component(4362, "FaciaHeadExtO_1", this, 1, (trackHelper.DoorPanelWidth) - jambInset + splHdAdd);
            Component.ComponentGroupType = "Frame-Components";
            Component.ComponentLabel = "";
            ...
            // FaciaHeadExtXX_2 ^^
            Component = new Component(4362, "FaciaHeadExtXX_2", this, 1, (trackHelper.DoorPanelWidth ) - spltHdRed + splHdAdd);
            Component.ComponentGroupType = "Frame-Components";
            Component.ComponentLabel = "";
            ...
            // FaciaHeadExtXXX_3 ^^
            Component = new Component(4362, "FaciaHeadExtXXX_3", this, 1, (trackHelper.DoorPanelWidth ) - jambInset - spltHdRed);
            Component.ComponentGroupType = "Frame-Components";
            Component.ComponentLabel = "";
            ...
            // Pile_LS_Seals ^^
            Component = new Component(4384, "Pile_LS_Seals", this, 1, (trackHelper.DoorPanelWidth * 2.0m) - jambDimW + doorGap - jambInset);
            Component.ComponentGroupType = "Pile_LS_Seals-Components";
            Component.ComponentLabel = "";
            ...
            // HDPE_Head ^^
            Component = new Component(3442, "HDPE_Head", this, 1, (trackHelper.DoorPanelWidth * panelCount) - stileOvrLpX2 + headHDPEadd2X);
            Component.ComponentGroupType = "Frame-Components";
            Component.ComponentLabel = notchHDPE;
            Component.ComponentThick = 0.75m;
            Component.ComponentWidth = 8.625m;
