    ...
    public class DrSwg2x4RH : SubAssemblyBase
    {
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                Component = new Component(4270, "HDPEBot", this, 1, (m_subAssemblyWidth - doorReduceX2 + hdpExtX2));
                Component.ComponentGroupType = "HDPE-Components";
                Component.ComponentWidth = Component.Source.Width;
                Component.ComponentThick = Component.Source.Height;
                Component.ComponentLabel = labelStileR = "";
            ...
            for (int i = 0; i < 4; i++)
            {
                ...
                Component = new Component(4588, "ExtMuntVert", this, 1, (m_subAssemblyHieght - sidMuntGPExt2) / 4.0m);
            ...
            for (int i = 0; i < 4; i++)
            {
                ...
                Component = new Component(4587, "IntMuntVert", this, 1, (m_subAssemblyHieght - sidMuntGPInt2) / 4.0m);
                Component.ComponentGroupType = "Muntins";
            ...
            for (int i = 0; i < 8; i++)
            {
                ...
                Component = new Component(4314, "EPDM_PreSet", this, 1, (m_subAssemblyHieght - sidMuntGPExt2) / 4.0m);
                Component.ComponentGroupType = "Seal-Components";
                Component.ComponentLabel = "";
            ...
            for (int i = 0; i < 8; i++)
            {
                ...
                Component = new Component(4284, "EPDM_Wedge", this, 1, (m_subAssemblyHieght - sidMuntGPInt2) / 4.0m);
                Component.ComponentGroupType = "Seal-Components";
                Component.ComponentLabel = "";
            ...
            for (int i = 0; i < 12; i++)
            {
                ...
                Component = new Component(4314, "EPDM_PreSet", this, 1, (m_subAssemblyWidth - sidMuntGPExt2) / 2.0m);
                Component.ComponentGroupType = "Seal-Components";
                Component.ComponentLabel = "";
            ...
            for (int i = 0; i < 12; i++)
            {
                ...
                Component = new Component(4284, "EPDM_Wedge", this, 1, (m_subAssemblyWidth - sidMuntGPInt2) / 2.0m);
                Component.ComponentGroupType = "Seal-Components";
                Component.ComponentLabel = "";
