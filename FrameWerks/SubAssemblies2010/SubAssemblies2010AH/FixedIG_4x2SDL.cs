    ...
    public class FixedIG_4x2SDL : SubAssemblyBase
    {
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 4; i++)
            {
                ...
                Component = new Component(4588, "ExtMuntHorz", this, 1, (m_subAssemblyWidth - sidMuntGPExt2) / 4.0m);
            ...
            for (int i = 0; i < 4; i++)
            {
                ...
                Component = new Component(4587, "IntMuntHorz", this, 1, (m_subAssemblyWidth - sidMuntGPInt2) / 4.0m);
                Component.ComponentGroupType = "Muntins";
                Component.ComponentLabel = "BEVEL_BISHOP_Ends";
            ...
            for (int i = 0; i < 6; i++)
            {
                ...
                Component = new Component(4588, "ExtMuntVert", this, 1, (m_subAssemblyWidth - sidMuntGPExt2) / 2.0m);
                Component.ComponentGroupType = "Muntins";
