    ...
    public class CaseUnit2x2RHR : SubAssemblyBase
    {
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                Component.ComponentLabel = "WELD_BISHOP_Ends";
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                Component = new Component(4588, "ExtMuntVert", this, 1, (m_subAssemblyHieght - sidMuntGPExt2) / 2.0m);
                Component.ComponentGroupType = "Muntins";
                Component.ComponentLabel = "WELD_BISHOP_Ends";
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                Component = new Component(4587, "IntMuntVert", this, 1, (m_subAssemblyHieght - sidMuntGPInt2) / 2.0m);
                Component.ComponentGroupType = "Muntins";
                Component.ComponentLabel = "BEVEL_BISHOP_Ends";
            ...
            for (int i = 0; i < 4; i++)
            {
                ...
                Component = new Component(4314, "EPDM_PreSet", this, 1, (m_subAssemblyHieght - sidMuntGPExt2) / 2.0m);
                Component.ComponentGroupType = "Seal-Components";
                Component.ComponentLabel = "";
            ...
            for (int i = 0; i < 4; i++)
            {
                ...
                Component = new Component(4284, "EPDM_Wedge", this, 1, (m_subAssemblyHieght - sidMuntGPInt2) / 2.0m);
                Component.ComponentGroupType = "Seal-Components";
                Component.ComponentLabel = "";
