...
namespace FrameWorks.Makes.System2010AH
{
    ...
    public class DoorSwg1LtActRH : SubAssemblyBase
    {
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 4; i++)
            {
                Component = new Component(4408, "SS_.4575_TYPE1", this, 1, 0.0m);
                Component.ComponentGroupType = "AssyBrackets-Components";
                Component.ComponentWidth = Component.Source.Width;
                Component.ComponentThick = Component.Source.Height;
                Component.ComponentLabel = "";
            ...
            for (int i = 0; i < 8; i++)
            {
                Component = new Component(4409, "SS_.6637_TYPE2", this, 1, 0.0m);
                Component.ComponentGroupType = "AssyBrackets-Components";
                Component.ComponentWidth = Component.Source.Width;
                Component.ComponentThick = Component.Source.Height;
                Component.ComponentLabel = "";
            ...
            for (int i = 0; i < 4; i++)
            {
                Component = new Component(4525, "ALUM_.7808_TYPE4", this, 1, 0.0m);
                Component.ComponentGroupType = "AssyBrackets-Components";
                Component.ComponentWidth = Component.Source.Width;
                Component.ComponentThick = Component.Source.Height;
                Component.ComponentLabel = "";
            ...
            for (int i = 0; i < 4; i++)
            {
                Component = new Component(4529, "ALUM_1.0446_TYPE5", this, 1, 0.0m);
                Component.ComponentGroupType = "AssyBrackets-Components";
                Component.ComponentWidth = Component.Source.Width;
                Component.ComponentThick = Component.Source.Height;
                Component.ComponentLabel = "";
