    ...
    public class FixedIG_2x4SDL : SubAssemblyBase
    {
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 6; i++)
            {
                ...
                Component = new Component(4588, "ExtMuntHorz", this, 1, (m_subAssemblyWidth - sidMuntGPExt2) / 2.0m);
            ...
            for (int i = 0; i < 6; i++)
            {
                ...
                Component = new Component(4587, "IntMuntHorz", this, 1, (m_subAssemblyWidth - sidMuntGPInt2) / 2.0m);
                Component.ComponentGroupType = "Muntins";
                Component.ComponentLabel = "BEVEL_BISHOP_Ends";
            ...
            for (int i = 0; i < 1; i++)
            {
                ...
                Component = new Component(4588, "ExtMuntVert", this, 1, 26.0629m);
                Component.ComponentGroupType = "Muntins";
                Component.ComponentLabel = "1)BEVEL_BISHOP_Ends";
            ...
            for (int i = 0; i < 1; i++)
            {
                ...
                Component = new Component(4588, "ExtMuntVert", this, 1, 24.2968m );
                Component.ComponentGroupType = "Muntins";
                Component.ComponentLabel = "2)BISHOP_BISHOP_Ends";
            ...
            for (int i = 0; i < 1; i++)
            {
                ...
                Component = new Component(4588, "ExtMuntVert", this, 1, 24.2969m );
                Component.ComponentGroupType = "Muntins";
                Component.ComponentLabel = "3)BISHOP_BISHOP_Ends";
            ...
            for (int i = 0; i < 1; i++)
            {
                ...
                Component = new Component(4588, "ExtMuntVert", this, 1, 26.1879m);
                Component.ComponentGroupType = "Muntins";
                Component.ComponentLabel = "4)BEVEL_BISHOP_Ends";
            ...
            for (int i = 0; i < 1; i++)
            {
                ...
                Component = new Component(4587, "IntMuntVert", this, 1, 26.0527m);
                Component.ComponentGroupType = "Muntins";
                Component.ComponentLabel = "1)BEVEL_BISHOP_Ends";
            ...
            for (int i = 0; i < 1; i++)
            {
                ...
                Component = new Component(4587, "IntMuntVert", this, 1, 24.2968m);
                Component.ComponentGroupType = "Muntins";
                Component.ComponentLabel = "2)BISHOP_BISHOP_Ends";
            ...
            for (int i = 0; i < 1; i++)
            {
                ...
                Component = new Component(4587, "IntMuntVert", this, 1, 24.2969m);
                Component.ComponentGroupType = "Muntins";
                Component.ComponentLabel = "3)BISHOP_BISHOP_Ends";
            ...
            for (int i = 0; i < 1; i++)
            {
                ...
                Component = new Component(4587, "IntMuntVert", this, 1, 26.1821m);
                Component.ComponentGroupType = "Muntins";
                Component.ComponentLabel = "4)BEVEL_BISHOP_Ends";
