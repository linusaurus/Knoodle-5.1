...
namespace FrameWorks.Makes.System2060
{
    ...
    public class DoorSwing2x4RHR : SubAssemblyBase
    {
        ...
        public override void Build()
        {
            ...
            // StrikePlateLH_RHR
            Component = new Component(5335, "StrikePlateLH_RHR", this, 1, 0.0m);
            ...
            for (int i = 0; i < 1; i++)
            {
                ...
                Component = new Component(5131, "RailBot", this, 1, m_subAssemblyWidth - doorReduceX2);
                Component.ComponentGroupType = "AlumTB3inch";
                Component.ComponentLabel = "1) Miter_Ends ";
            ...
            for (int i = 0; i < 12; i++)
            {
                ...
                Component = new Component(5306, "MuntHorz", this, 1, (m_subAssemblyWidth - sidMuntGP2 ) / 2.0m);
