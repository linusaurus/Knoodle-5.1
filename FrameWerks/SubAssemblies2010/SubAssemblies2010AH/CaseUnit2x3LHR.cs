    ...
    public class CaseUnit2x3LHR : SubAssemblyBase
    {
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 3; i++)
            {
                ...
                Component = new Component(4588, "ExtMuntVert", this, 1, (m_subAssemblyHieght - sidMuntGPExt2) / 3.0m);
                Component.ComponentGroupType = "Muntins";
                Component.ComponentLabel = "WELD_BISHOP_Ends";
            ...
            for (int i = 0; i < 3; i++)
            {
                ...
                Component = new Component(4587, "IntMuntVert", this, 1, (m_subAssemblyHieght - sidMuntGPInt2) / 3.0m);
                Component.ComponentGroupType = "Muntins";
                Component.ComponentLabel = "BEVEL_BISHOP_Ends";
