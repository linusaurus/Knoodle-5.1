    ...
    public class FixedIG_2x3SDL : SubAssemblyBase
    {
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 1; i++)
            {
                ...
                Component = new Component(4588, "ExtMuntVert", this, 1, 31.8286m);
                Component.ComponentGroupType = "Muntins";
            ...
            for (int i = 0; i < 1; i++)
            {
                ...
                Component = new Component(4588, "ExtMuntVert", this, 1, 30.0625m);
                Component.ComponentGroupType = "Muntins";
            ...
            for (int i = 0; i < 1; i++)
            {
                ...
                Component = new Component(4588, "ExtMuntVert", this, 1, 31.7034m);
                Component.ComponentGroupType = "Muntins";
                Component.ComponentLabel = "3)BEVEL_BISHOP_Ends";
            ...
            for (int i = 0; i < 1; i++)
            {
                ...
                Component = new Component(4587, "IntMuntVert", this, 1, 31.8228m);
                Component.ComponentGroupType = "Muntins";
                Component.ComponentLabel = "1)BEVEL_BISHOP_Ends";
            ...
            for (int i = 0; i < 1; i++)
            {
                ...
                Component = new Component(4587, "IntMuntVert", this, 1, 30.0626m);
                Component.ComponentGroupType = "Muntins";
                Component.ComponentLabel = "2)BISHOP_BISHOP_Ends";
            ...
            for (int i = 0; i < 1; i++)
            {
                ...
                Component = new Component(4587, "IntMuntVert", this, 1, 31.6977m);
                Component.ComponentGroupType = "Muntins";
                Component.ComponentLabel = "3)BEVEL_BISHOP_Ends";
            ...
            Component.ComponentLabel = "SDL_2x3";
