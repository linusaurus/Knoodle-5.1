...
namespace FrameWorks.Makes.System2010
{
    ...
    public class NailFinMtr6 : SubAssemblyBase
    {
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                Component = new Component(4373, "NailerWidthExt", this, 1, m_subAssemblyWidth + nailFinAd - nailFinRed);
            ...
            for (int i = 0; i < 2; i++)
            {
                Component = new Component(4373, "NailerDepthExt", this, 1, m_subAssemblyDepth + nailFinAd - nailFinRed);
                Component.ComponentGroupType = "NailFin-Components";
                Component.ComponentLabel = "1)MiterEnds";
