...
namespace FrameWorks.Makes.System2010
{
    ...
    public class FixedLouvScrn : SubAssemblyBase
    {
        ...
        public override void Build()
        {
            ...
            Component.FunctionalName = "Louver";
            Component.ComponentGroupType = "Louver_Screen-Components";
            Component.Qnty = 1;
            ...
            Component.FunctionalName = "Screen_Frame";
            Component.ComponentGroupType = "Louver_Screen-Components";
            Component.Qnty = 1;
            Component.ContainerAssembly = this;
            Component.ComponentWidth = m_subAssemblyWidth - (glassReduce * 2.0m);
            Component.ComponentLength = m_subAssemblyHieght - (glassReduce * 2.0m);
            Component.ComponentThick = 0.4375m;
            ...
            for (int i = 0; i < 1; i++)
            {
                ...
                //FoamTape
                Component = new Component(911, "FoamTape", this, 1, peri);
                Component.ComponentGroupType = "GlazingSeal-Components";
                Component.ComponentLabel = "";
