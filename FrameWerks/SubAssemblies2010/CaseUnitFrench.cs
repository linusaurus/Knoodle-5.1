...
namespace FrameWorks.Makes.System2010
{
    ...
    public class CaseUnitFrench : SubAssemblyBase
    {
        ...
        public override void Build()
        {
            ...
            // RailAlumT ^^
            Component = new Component(4350, "RailAlumT", this, 1,( m_subAssemblyWidth - frameReduce2X - astragalGap) /2.0m);
            Component.ComponentGroupType = "Sash-Components";
            Component.ComponentWidth = Component.Source.Width;
            Component.ComponentThick = Component.Source.Height;
            ...
            // RailAlumB ||
            Component = new Component(4350, "RailAlumB", this, 1, (m_subAssemblyWidth - frameReduce2X - astragalGap) /2.0m);
            Component.ComponentGroupType = "Sash-Components";
            Component.ComponentWidth = Component.Source.Width;
            Component.ComponentThick = Component.Source.Height;
            ...
            // Astragal
            Component = new Component(4356, "Astragal", this, 1, m_subAssemblyHieght - gaskFrmReduce * 2.0m );
            Component.ComponentGroupType = "Sash";
            Component.ComponentLabel = "";
            ...
            for (int i = 0; i < 4; i++)
            {
                Component = new Component(4341, "AlumGlsStpHz", this, 1, (m_subAssemblyWidth - gstopReduce2X - astagalGapHalf) / 2.0m);
                Component.ComponentGroupType = "StopAlum-Components";
                Component.ComponentWidth = Component.Source.Width;
                Component.ComponentThick = Component.Source.Height;
                Component.ComponentLabel = "";
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                Component.ComponentWidth = ((m_subAssemblyWidth - glassReduce2X - glassRedMid2X) / 2.0m);
            ...
            {
                //SashEdgeSeal
                Component = new Component(2274, "SashEdgeSeal", this, 1, m_subAssemblyHieght - gstopReduce2X );
                Component.ComponentGroupType = "Seal-Components";
                Component.ComponentLabel = "";
