...
{
    [Serializable()]
    public class SubFrmMtrDblReturn : SubAssemblyBase
    {
        ...
        public SubFrmMtrDblReturn()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "Tiburon-SubFrmMtrDblReturn";
        }
        ...
        public override void Build()
        {
            ...
            // SubFrameAssyLeft <<--
            part = new Part(3076, "SubFrameAssyJL", this, 1, m_subAssemblyHieght - 0.50m );
            ...
            // SubFrameAssyRight -->
            part = new Part(3076, "SubFrameAssyJR", this, 1, m_subAssemblyHieght - 0.50m );
            part.PartGroupType = "SubFrameAssy-Parts";
            part.PartWidth = part.Source.Width;
            part.PartThick = part.Source.Height;
            part.PartLabel = "";
            ...
            // SubFrameAssyHead ^^
            part = new Part(3076, "SubFrameAssyHeadFace", this, 1, m_subAssemblyWidth - 2.0m * 0.14477244m );
            part.PartGroupType = "SubFrameAssy-Parts";
            part.PartWidth = part.Source.Width;
            part.PartThick = part.Source.Height;
            part.PartLabel = "";
            ...
            // SubFrameAssyHead ^^
            part = new Part(3076, "SubFrameAssyHeadDepthL", this, 1, m_subAssemblyDepth - 1.0m * 0.14477244m );
            part.PartGroupType = "SubFrameAssy-Parts";
            part.PartWidth = part.Source.Width;
            part.PartThick = part.Source.Height;
            part.PartLabel = "";
            ...
            // SubFrameAssyHead ^^
            part = new Part(3076, "SubFrameAssyHeadDepthR", this, 1, m_subAssemblyDepth - 1.0m * 0.14477244m );
            part.PartGroupType = "SubFrameAssy-Parts";
            part.PartWidth = part.Source.Width;
            part.PartThick = part.Source.Height;
            part.PartLabel = "";
            ...
            // SubFrameAssySill ||
            part = new Part(3076, "SubFrameAssySill", this, 1, m_subAssemblyWidth - 2.0m * 0.14477244m);
            part.PartGroupType = "SubFrameAssy-Parts";
            part.PartWidth = part.Source.Width;
            part.PartThick = part.Source.Height;
            part.PartLabel = "";
            ...
            part = new Part(3076, "SubFrameAssySillDepthL", this, 1, m_subAssemblyDepth - 1.0m * 0.14477244m);
            part.PartGroupType = "SubFrameAssy-Parts";
            part.PartWidth = part.Source.Width;
            part.PartThick = part.Source.Height;
            part.PartLabel = "";
            ...
            part = new Part(3076, "SubFrameAssySillDepthR", this, 1, m_subAssemblyDepth - 1.0m * 0.14477244m);
            part.PartGroupType = "SubFrameAssy-Parts";
            part.PartWidth = part.Source.Width;
            part.PartThick = part.Source.Height;
            part.PartLabel = "";
