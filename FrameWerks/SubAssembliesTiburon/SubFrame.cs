...
{
    [Serializable()]
    public class SubFrame : SubAssemblyBase
    {
        ...
        public override void Build()
        {
            ...
            // SubFrameAssyLeft <<--
            part = new Part(3076, "SubFrameAssyJL", this, 1, m_subAssemblyHieght - 2 * 0.50m);
            ...
            // SubFrameAssyRight -->
            part = new Part(3076, "SubFrameAssyJR", this, 1, m_subAssemblyHieght - 2 * 0.50m);
            part.PartGroupType = "SubFrameAssy-Parts";
            part.PartWidth = part.Source.Width;
            part.PartThick = part.Source.Height;
            part.PartLabel = "";
