...
{
    [Serializable()]
    public class SubFrame7BrzSide3 : SubAssemblyBase
    {
        ...
        public SubFrame7BrzSide3()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "Tiburon-SubFrame7BrzSide3";
        }
        ...
        public override void Build()
        {
            ...
            // SubFrameAssyLeft <<--
            part = new Part(3074, "SubFrameAssyJL", this, 1, m_subAssemblyHieght - 1 * .5m);
            ...
            // SubFrameAssyRight -->
            part = new Part(3074, "SubFrameAssyJR", this, 1, m_subAssemblyHieght - 1 * .5m);
            part.PartGroupType = "SubFrameAssy-Parts";
            part.PartWidth = part.Source.Width;
            part.PartThick = part.Source.Height;
            part.PartLabel = "";
            ...
            // CapAssyBrzOuterLeft <<--
            part = new Part(3140, "CapAssyBrzExtL", this, 1, m_subAssemblyHieght - 1 * .5m);
            ...
            // CapAssyBrzInnerLeft <<--
            part = new Part(3140, "CapAssyBrzIntL", this, 1, m_subAssemblyHieght - 1 * .5m);
            part.PartGroupType = "CapAssyBrz-Parts";
            part.PartWidth = part.Source.Width;
            part.PartThick = part.Source.Height;
            part.PartLabel = "";
            ...
            part = new Part(3140, "CapAssyBrzExtR", this, 1, m_subAssemblyHieght - 1 * .5m);
            part.PartGroupType = "CapAssyBrz-Parts";
            part.PartWidth = part.Source.Width;
            part.PartThick = part.Source.Height;
            part.PartLabel = "";
            ...
            part = new Part(3140, "CapAssyBrzIntR", this, 1, m_subAssemblyHieght - 1 * .5m);
            part.PartGroupType = "CapAssyBrz-Parts";
            part.PartWidth = part.Source.Width;
            part.PartThick = part.Source.Height;
            part.PartLabel = "";
