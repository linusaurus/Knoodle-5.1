...
{
    [Serializable()]
    public class FrmSSFxdSnglIGMtrLft5_5 : SubAssemblyBase
    {
        ...
        public FrmSSFxdSnglIGMtrLft5_5()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "Tiburon-FrmSSFxdSnglIGMtrLft5_5";
        }
        ...
        public override void Build()
        {
            ...
            part.PartWidth = m_subAssemblyDepth - (0.25m * 1.0m) + (1.8125m * 1.0m);
