...
{
    [Serializable()]
    public class FrameSSCaseMotor9_25 : SubAssemblyBase
    {
        ...
        public FrameSSCaseMotor9_25()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "Tiburon-FrameSSCaseMotor9_25";
        }
        ...
        public override void Build()
        {
            ...
            // FrmAglExtL <<--
            part = new Part(3299, "FrmAglExtL", this, 1, m_subAssemblyHieght);
            ...
            // FrmAglExtH ^^
            part = new Part(3299, "FrmAglExtH", this, 1, m_subAssemblyWidth);
            part.PartGroupType = "FrameAngleCasement-Parts";
            part.PartWidth = part.Source.Width;
            part.PartThick = part.Source.Height;
            part.PartLabel = "";
            ...
            // FrmAglExtS ||
            part = new Part(3299, "FrmAglExtS", this, 1, m_subAssemblyWidth);
            part.PartGroupType = "FrameAngleCasement-Parts";
            part.PartWidth = part.Source.Width;
            part.PartThick = part.Source.Height;
            part.PartLabel = "";
