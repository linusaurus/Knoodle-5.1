...
namespace FrameWorks.Makes.Tiburon
{
    ...
    public class DoorPivotBrzGlassLHR : SubAssemblyBase
    {
        ...
        public DoorPivotBrzGlassLHR()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "Tiburon-DoorPivotBrzGlassLHR";
        }
        ...
        public override void Build()
        {
            ...
            // StileExtL <<--
            part = new Part(3103, "StileExtL", this, 1, m_subAssemblyHieght);
            part.PartGroupType = "ExtCladBrz-Parts";
            part.PartWidth = part.Source.Width;
            part.PartThick = part.Source.Height;
            part.PartLabel = "";
            ...
            // StileExtR -->>
            part = new Part(3103, "StileExtR", this, 1, m_subAssemblyHieght);
            part.PartGroupType = "ExtCladBrz-Parts";
            part.PartWidth = part.Source.Width;
            part.PartThick = part.Source.Height;
            part.PartLabel = "";
            ...
            // RailExtT ^^
            part = new Part(3103, "RailExtT", this, 1, m_subAssemblyWidth);
            part.PartGroupType = "ExtCladBrz-Parts";
            part.PartWidth = part.Source.Width;
            part.PartThick = part.Source.Height;
            part.PartLabel = "";
            ...
            // RailExtB ||
            part = new Part(3103, "RailExtB", this, 1, m_subAssemblyWidth);
            part.PartGroupType = "ExtCladBrz-Parts";
            part.PartWidth = part.Source.Width;
            part.PartThick = part.Source.Height;
            part.PartLabel = "";
            ...
            // StileIntL <<--
            part = new Part(3103, "StileIntL", this, 1, m_subAssemblyHieght);
            part.PartGroupType = "IntCladBrz-Parts";
            part.PartWidth = part.Source.Width;
            part.PartThick = part.Source.Height;
            part.PartLabel = "";
            ...
            // StileIntR -->>
            part = new Part(3103, "StileIntR", this, 1, m_subAssemblyHieght);
            part.PartGroupType = "IntCladBrz-Parts";
            part.PartWidth = part.Source.Width;
            part.PartThick = part.Source.Height;
            part.PartLabel = "";
            ...
            // RailIntT ^^
            part = new Part(3103, "RailIntT", this, 1, m_subAssemblyWidth);
            part.PartGroupType = "IntCladBrz-Parts";
            part.PartWidth = part.Source.Width;
            part.PartThick = part.Source.Height;
            part.PartLabel = "";
            ...
            // RailIntB ||
            part = new Part(3103, "RailIntB", this, 1, m_subAssemblyWidth);
            part.PartGroupType = "IntCladBrz-Parts";
            part.PartWidth = part.Source.Width;
            part.PartThick = part.Source.Height;
            part.PartLabel = "";
            ...
            // Hinge
            part = new Part(911, "PivotSet", this, 3, 0.0m);
            ...
            part = new Part(3383, "HDPEdgeHingeLeft", this, 1, m_subAssemblyHieght);
            part.PartGroupType = "HDPEdge-Parts";
            part.PartLabel = "";

            m_parts.Add(part);

            part = new Part(3335, "HDPEdgeLatchRight", this, 1, m_subAssemblyHieght);
            part.PartGroupType = "HDPEdge-Parts";
            part.PartLabel = "";
