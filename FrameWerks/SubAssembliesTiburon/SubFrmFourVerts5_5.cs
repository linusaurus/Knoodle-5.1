...
{
    [Serializable()]
    public class SubFrmFourVerts5_5 : SubAssemblyBase
    {
        ...
        public SubFrmFourVerts5_5()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "Tiburon-SubFrmFourVerts5_5";
        }
        ...
        public override void Build()
        {
            ...
            //GeSilpruf
            part = new Part(759, "GE SilPruf", this, 1, m_subAssemblyHieght + 4 * 2.0m);
