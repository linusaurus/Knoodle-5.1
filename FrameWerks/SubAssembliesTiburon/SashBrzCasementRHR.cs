...
{
    [Serializable()]
    public class SashBrzCasementRHR : SubAssemblyBase
    {
        ...
        public SashBrzCasementRHR()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System3250-SashBrzCasementRHR";
        }
        #endregion
        ...
        public override void Build()
        {
            ...
            // StileBrzExtL <<--
            part = new Part(3101, "StileBrzExtL", this, 1, m_subAssemblyHieght);
            ...
            // StileBrzExtR -->>
            part = new Part(3101, "StileBrzExtR", this, 1, m_subAssemblyHieght);
            part.PartGroupType = "ExtCladBrz-Parts";
            part.PartWidth = part.Source.Width;
            part.PartThick = part.Source.Height;
            part.PartLabel = labelStileR;
            ...
            // RailBrzExtT ^^
            part = new Part(3101, "RailBrzExtT", this, 1, m_subAssemblyWidth);
            part.PartGroupType = "ExtCladBrz-Parts";
            part.PartWidth = part.Source.Width;
            part.PartThick = part.Source.Height;
            part.PartLabel = labelTopRail;
            ...
            // RailBrzExtB ||
            part = new Part(3101, "RailBrzExtB", this, 1, m_subAssemblyWidth);
            part.PartGroupType = "ExtCladBrz-Parts";
            part.PartWidth = part.Source.Width;
            part.PartThick = part.Source.Height;
            part.PartLabel = labelBotRail;
            ...
            // StileBrzIntL <<--
            part = new Part(3098, "StileBrzIntL", this, 1, m_subAssemblyHieght - 2 * .75m);
            ...
            // StileIntR -->>
            part = new Part(3098, "StileIntR", this, 1, m_subAssemblyHieght - 2 * .75m);
            part.PartGroupType = "IntCladBrz-Parts";
            part.PartWidth = part.Source.Width;
            part.PartThick = part.Source.Height;
            part.PartLabel = labelStileR;
            ...
            // RailIntT ^^
            part = new Part(3098, "RailIntT", this, 1, m_subAssemblyWidth - 2 * .75m);
            part.PartGroupType = "IntCladBrz-Parts";
            part.PartWidth = part.Source.Width;
            part.PartThick = part.Source.Height;
            part.PartLabel = labelTopRail;
            ...
            // RailIntB ||
            part = new Part(3098, "RailIntB", this, 1, m_subAssemblyWidth - 2 * .75m);
            part.PartGroupType = "IntCladBrz-Parts";
            part.PartWidth = part.Source.Width;
            part.PartThick = part.Source.Height;
            part.PartLabel = labelBotRail;
