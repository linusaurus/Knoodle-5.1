...
{
    [Serializable()]
    public class SubFrmMtrRt : SubAssemblyBase
    {
        ...
        public SubFrmMtrRt()
        {
            ...
            this.ModelID = "Tiburon-SubFrmMtrRt";
        }
        ...
        public override void Build()
        {
            ...
            // SubFrameAssyHead ^^
            part = new Part(3076, "SubFrameAssyHeadFace", this, 1, m_subAssemblyWidth - 1.0m * 0.14477244m);
            part.PartGroupType = "SubFrameAssy-Parts";
            part.PartWidth = part.Source.Width;
            part.PartThick = part.Source.Height;
            part.PartLabel = "";
            ...
            // SubFrameAssySill ||
            part = new Part(3076, "SubFrameAssySill", this, 1, m_subAssemblyWidth - 1.0m * 0.14477244m);
            part.PartGroupType = "SubFrameAssy-Parts";
            part.PartWidth = part.Source.Width;
            part.PartThick = part.Source.Height;
            part.PartLabel = "";
