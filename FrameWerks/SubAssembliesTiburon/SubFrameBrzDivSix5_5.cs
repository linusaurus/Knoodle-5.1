...
{
    [Serializable()]
    public class SubFrameBrzDivSix5_5 : SubAssemblyBase
    {
        ...
        public SubFrameBrzDivSix5_5()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "Tiburon-SubFrameBrzDivSix5_5";
        }
        ...
        public override void Build()
        {
            ...
            // SubFrameAssyHead ^^
            part = new Part(3076, "SubFrameAssyH", this, 1, m_subAssemblyWidth + 32.00m);
            ...
            // CapAssyBrzOuterTop ^^
            part = new Part(3140, "CapAssyBrzExtT", this, 1, m_subAssemblyWidth + 32.0m);
            ...
            // CapAssyBrzInnerTop ^^
            part = new Part(3140, "CapAssyBrzIntT", this, 1, m_subAssemblyWidth + 32.0m);
            part.PartGroupType = "CapAssyBrz-Parts";
            part.PartWidth = part.Source.Width;
            part.PartThick = part.Source.Height;
            part.PartLabel = "";
