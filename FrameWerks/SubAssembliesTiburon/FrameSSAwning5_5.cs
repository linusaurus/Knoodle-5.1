...
{
    [Serializable()]
    public class FrameSSAwning_5_5 : SubAssemblyBase
    {
        ...
        public FrameSSAwning_5_5()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "Tiburon-FrameSSAwning_5_5";
        }
        ...
        public override void Build()
        {
            ...
            #region FrameAngleAwnInt



            // FrmAglIntL <<--
            part = new Part(3084, "FrmAglIntL", this, 1, m_subAssemblyHieght);
            part.PartGroupType = "FrameAngleAwnInt-Parts";
            part.PartWidth = part.Source.Width;
            part.PartThick = part.Source.Height;
            part.PartLabel = "";
            ...
            // Operator Custom Casement
            part = new Part(3118, "OperatorCasement", this, 1, 0.0m);
            ...
            // CustomFoldingHandle
            part = new Part(911, "FoldingHandle", this, 1, 0.0m);
            part.PartGroupType = "Hardware-Parts";
            part.PartLabel = "CustomHamdle";
            part.PartIdentifier = partleader + "." + Convert.ToString(createID++);
            m_parts.Add(part);
