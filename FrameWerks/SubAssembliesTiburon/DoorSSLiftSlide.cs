...
{
    [Serializable()]
    public class DoorSSLiftSlide : SubAssemblyBase
    {
        ...
        public DoorSSLiftSlide()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "SystemTiburon-DoorSSLiftSlide";
        }
        #endregion
        ...
        public override void Build()
        {
            ...
            part = new Part(911, "HDPEdgeInt", this, 1, m_subAssemblyHieght);
            part.PartGroupType = "HDPEdge-Parts";
            part.PartLabel = "";

            m_parts.Add(part);

            part = new Part(911, "HDPEdgeRight", this, 1, m_subAssemblyHieght);
            part.PartGroupType = "HDPEdge-Parts";
            part.PartLabel = "";

            m_parts.Add(part);

            part = new Part(911, "HDPEdgeTop", this, 1, m_subAssemblyWidth);
            part.PartGroupType = "HDPEdge-Parts";
            part.PartLabel = "";

            m_parts.Add(part);

            part = new Part(911, "HDPEdgeBottom", this, 1, m_subAssemblyWidth);
            part.PartGroupType = "HDPEdge-Parts";
            part.PartLabel = "";
            ...
            #region CarriageRollerKit

            // Roller Kit
            part = new Part(1884, "CarriageRollerKit", this, 1, 0.0m);
            part.PartGroupType = "CarriageRollerKit";
            part.PartLabel = "";
            ...
            // DoorGear
            part = new Part(911, "DoorGear", this, 1, 0.0m);
            part.PartGroupType = "DoorGear";
            part.PartLabel = "";

            #endregion

            #region HandleLiftSlide


            // HandleLiftSlide
            part = new Part(911, "HandleLiftSlide", this, 1, 0.0m);
            part.PartGroupType = "HandleLiftSlide";
            part.PartLabel = "";
