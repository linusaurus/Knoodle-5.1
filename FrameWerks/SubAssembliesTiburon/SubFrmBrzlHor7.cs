...
{
    [Serializable()]
    public class SubFrmBrzHor7 : SubAssemblyBase
    {
        ...
        public SubFrmBrzHor7()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "Tiburon-SubFrmBrzHor7";
        }
        ...
        public override void Build()
        {
            ...
            // SubFrameAssyHorz
            part = new Part(3074, "SubFrameAssyHorz", this, 1, m_subAssemblyWidth);
            ...
            // CapAssyBrzOuterHorz
            part = new Part(3140, "CapAssyBrzExtHorz", this, 1, m_subAssemblyWidth);
            ...
            // CapAssyBrzInnerHorz ^^
            part = new Part(3140, "CapAssyBrzIntHorz", this, 1, m_subAssemblyWidth);
            part.PartGroupType = "CapAssyBrz-Parts";
            part.PartWidth = part.Source.Width;
            part.PartThick = part.Source.Height;
            part.PartLabel = "";
