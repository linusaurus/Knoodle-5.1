...
{
    [Serializable()]
    public class FrameSS_5_5DoorRH : SubAssemblyBase
    {
        ...
        public FrameSS_5_5DoorRH()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "Tiburon-FrameSS_5_5DoorRH";
        }
        ...
        public override void Build()
        {
            ...
            // FrmAglExtL <<--
            part = new Part(3079, "FrmAglExtL", this, 1, m_subAssemblyHieght);
            ...
            // FrmAglExtR -->
            part = new Part(3079, "FrmAglExtR", this, 1, m_subAssemblyHieght);
            part.PartGroupType = "FrameAngleDoor-Parts";
            part.PartWidth = part.Source.Width;
            part.PartThick = part.Source.Height;
            part.PartLabel = "";
            ...
            // FrmAglExtH ^^
            part = new Part(3079, "FrmAglExtH", this, 1, m_subAssemblyWidth);
            part.PartGroupType = "FrameAngleDoor-Parts";
            part.PartWidth = part.Source.Width;
            part.PartThick = part.Source.Height;
            part.PartLabel = "";
