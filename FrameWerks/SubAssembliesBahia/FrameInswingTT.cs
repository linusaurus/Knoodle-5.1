...
namespace FrameWorks.Makes.Bahia
{
    ...
    public class FrameInswingTT : SubAssemblyBase
    {
        ...
        public FrameInswingTT()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "Bahia-FrameInswingTT";
        }
        ...
        public override void Build()
        {
            ...
            part = new Part(3452, "TTJambL", this, 1, m_subAssemblyHieght);
            ...
            part = new Part(3452, "TTJambR", this, 1, m_subAssemblyHieght);
            part.PartGroupType = "Frame-Parts";
            part.PartLabel = "1)MiterEnds" + "\r\n" +
                             "2)MachineAwningHinge";
            m_parts.Add(part);
            ...
            part = new Part(3452, "TTHead", this, 1, m_subAssemblyWidth);
            part.PartGroupType = "Frame-Parts";
            part.PartLabel = "1)MiterEnds";
            m_parts.Add(part);
            ...
            part = new Part(3452, "TTSill", this, 1, m_subAssemblyWidth);
            part.PartGroupType = "Frame-Parts";
            part.PartLabel = "1)MiterEnds";
            m_parts.Add(part);
            ...
            // TiltTurn
            part = new Part(911, "TiltTurn", this, 1, 0m);
