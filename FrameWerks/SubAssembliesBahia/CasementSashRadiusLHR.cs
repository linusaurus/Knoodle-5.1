...
namespace FrameWorks.Makes.Bahia
{
    ...
    public class CasementSashRadiusLHR : SubAssemblyBase
    {
        ...
        public CasementSashRadiusLHR()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "Bahia-CasementSashRadiusLHR";
        }
        ...
        public override void Build()
        {
            ...
            part.PartLabel = labelTopRail = "StretchForm";

            m_parts.Add(part);


            // StileL <<--
            part = new Part(3397, "StileL", this, 1, (m_subAssemblyHieght - m_subAssemblyWidth) + (3 * sashGap));
            part.PartGroupType = "Sash-Parts";
            part.PartWidth = part.Source.Width;
            part.PartThick = part.Source.Height;
            ...
            part.PartWidth = part.Source.Width;
            part.PartThick = part.Source.Height;
            part.PartLabel = labelBotRail = "1)MiterBotEnd" + "\r\n" +
                                            "2)Machine3121Left";
            ...
            // StopTopArched #3396
            part = new Part(3396, "StopTopArched", this, 1, arcLength - sashGap - (2 * stopInset) + strechGrip);
            ...
            // Stop-L #3396
            part = new Part(3396, "GlassStop-L", this, 1, m_subAssemblyHieght - stopInset - m_subAssemblyWidth - (sashGap /2) );
            part.PartGroupType = "GlassStop-Parts";
