...
namespace FrameWorks.Makes.Bahia
{
    ...
    public class CasementSashRHR : SubAssemblyBase
    {
        ...
        public CasementSashRHR()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "Bahia-CasementSashRHR";
        }
        ...
        public override void Build()
        {
            ...
            // HingeCaseUR
            part = new Part(3121, "HingeCaseUR", this, 1, 0.0m);
            ...
            // HingeCaseLR
            part = new Part(3121, "HingeCaseLR", this, 1, 0.0m);
            part.PartGroupType = "Hardware";
            part.PartLabel = "";
            ...
            // Stop-L #3396
            part = new Part(3396, "GlassStop-L", this, 1, m_subAssemblyHieght - 2 * 0.5625m);
            ...
            // Stop-R #3396
            part = new Part(3396, "GlassStop-R", this, 1, m_subAssemblyHieght - 2 * 0.5625m);
            part.PartGroupType = "GlassStop-Parts";
            part.PartLabel = "MiterEnds";
            ...
            part = new Part(3396, "GlassStop-T", this, 1, m_subAssemblyWidth - 2 * 0.5625m);
            part.PartGroupType = "GlassStop-Parts";
            part.PartLabel = "MiterEnds";
            ...
            string crap;
            crap = FrameWorks.Functions.StopWeepMachining(m_subAssemblyWidth - 2 * 0.5625m);
            part = new Part(3396, "GlassStop-B", this, 1, m_subAssemblyWidth - 2 * 0.5625m);
            part.PartGroupType = "GlassStop-Parts";
