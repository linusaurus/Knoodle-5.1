...
namespace FrameWorks.Makes.Bahia
{
    ...
    public class DoorBiFoldJamb : SubAssemblyBase
    {
        ...
        public DoorBiFoldJamb()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "Bahia-DoorBiFoldJamb";
        }
        ...
        public override void Build()
        {
            ...
            // PivotSet ||
            part = new Part(2998, "PivotSet", this, 1, 0.0m);
            ...
            // TwinpointHandle ||
            part = new Part(3224, "TwinpointHandle", this, 1, 0.0m);
            part.PartGroupType = "Hardware-Parts";
            part.PartLabel = "";
            ...
            // TwinpointLock ||
            part = new Part(3329, "TwinpointLock", this, 1, 0.0m);
            part.PartGroupType = "Hardware-Parts";
            part.PartLabel = "";
