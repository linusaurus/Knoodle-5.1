...
namespace FrameWorks.Makes.Bahia
{
    ...
    public class CasementSashArchRHR : SubAssemblyBase
    {
        ...
        public CasementSashArchRHR()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "Bahia-CasementSashArchRHR";
        }
        ...
        public override void Build()
        {
            ...
            // StopTopArched #3396
            part = new Part(3396, "StopTopArched", this, 1, arcLength - (2 * stopInset) + strechGrip);
