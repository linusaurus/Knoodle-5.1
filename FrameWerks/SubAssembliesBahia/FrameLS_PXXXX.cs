...
namespace FrameWorks.Makes.Bahia
{
    ...
    public class FrameLS_PXXXX : SubAssemblyBase
    {
        ...
        public FrameLS_PXXXX()
        {
            ...
            this.ModelID = "Bahia-FrameLS_PXXXX";
        }
        ...
        public override void Build()
        {
...

            {
                ...
                part = new Part(3406, "TopTrackYPXXXX", this, 1, (trackHelper.DoorPanelWidth * 5) - (3 * stileWidth) + (doorGap));
                part.PartGroupType = "TopTrackY-Parts";
                part.PartLabel = "";
                ...
                // FaciaHeadExtPXXXX ^^
                part = new Part(3404, "FaciaHeadExtPXXXX", this, 1, (trackHelper.DoorPanelWidth) - (stileWidth) - (stileOfst) + (jamB) + (doorGap) + (beYond) - (calkGap));
                part.PartGroupType = "Frame-Parts";
                part.PartLabel = "";
                ...
                // FaciaHeadInt ^^
                part = new Part(3404, "FaciaHeadInt", this, 1, (trackHelper.DoorPanelWidth * 4) - (stileWidth * 3) + (jamB) + (pocketInset) + (doorGap));
                part.PartGroupType = "Frame-Parts";
                part.PartLabel = "";
                ...
                // HDMPHead ^^
                part = new Part(3467, "HDMPHead", this, 1, (trackHelper.DoorPanelWidth * 5) - (3 * stileWidth) + (jamB) + (doorGap));
                part.PartGroupType = "Frame-Parts";
                part.PartLabel = "";
