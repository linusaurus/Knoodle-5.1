...
namespace FrameWorks.Makes.Bahia
{
    ...
    public class Fixed4LiteIG : SubAssemblyBase
    {
        ...
        const decimal glassFrame= 0.96875m;
        ...
        public Fixed4LiteIG()
        {
            ...
            this.ModelID = "Bahia-Fixed4LiteIG";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 4; i++)
            {
                ...
                part.Qnty = 1;
                part.ContainerAssembly = this;
                part.PartWidth = (m_subAssemblyWidth - glassFrame*2.0m - glassMuntGap * 2.0m) / 2.0m;
                part.PartLength = (m_subAssemblyHieght - glassFrame*2.0m - glassMuntGap * 2.0m) / 2.0m;
            ...
            for (int i = 0; i < 4; i++)
            {
                ...
                rectSeal = (m_subAssemblyWidth - 2 * glassFrame- 2 * glassMuntGap) / 2.0m * 2.0m;
                rectSeal += (m_subAssemblyHieght - 2 * glassFrame - 2 * glassMuntGap) / 2.0m * 2.0m;
                rectSeal *= 2.0m;
