...
namespace FrameWorks.Makes.Bahia
{
    ...
    public class FrameSwingPair : SubAssemblyBase
    {
        ...
        public FrameSwingPair()
        {
            ...
            this.ModelID = "Bahia-FrameSwingPair";
        }
        ...
        public override void Build()
        {
            ...
            // ASTRIGAL COVER ALUM
            part = new Part(3411, "ASTRIGAL COVER ALUM", this, 1, m_subAssemblyHieght);
            ...
            // PVC ASTRAGAL
            part = new Part(1901, "PVC ASTRAGAL", this, 1, m_subAssemblyHieght );
            part.PartGroupType = "Hardware-Parts";
            part.PartLabel = "";
