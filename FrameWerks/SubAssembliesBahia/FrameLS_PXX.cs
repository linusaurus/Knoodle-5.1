...
namespace FrameWorks.Makes.Bahia
{
    ...
    public class FrameLS_PXX : SubAssemblyBase
    {
        ...
        public FrameLS_PXX()
        {
            ...
            this.ModelID = "Bahia-FrameLS_PXX";
        }
        ...
        public override void Build()
        {
...

            {
                ...
                // TopTrackYPXX
                part = new Part(3406, "TopTrackYPXX", this, 1, (trackHelper.DoorPanelWidth * 3) - (stileWidth) + doorGap - pocketInset);
                part.PartGroupType = "TopTrackY-Parts";
                part.PartLabel = "";
                ...
                // FaciaHeadExtPXX ^^
                part = new Part(3404, "FaciaHeadExtPXX", this, 1, (trackHelper.DoorPanelWidth) - (midOverLap) + (jamB) + (doorGap) );
                part.PartGroupType = "Frame-Parts";
                part.PartLabel = "";
                ...
                // FaciaHeadInt ^^
                part = new Part(3404, "FaciaHeadInt", this, 1, (trackHelper.DoorPanelWidth * 2) - (stileWidth) + (jambInset) + (jamB) + (doorGap));
                part.PartGroupType = "Frame-Parts";
                part.PartLabel = "";
                ...
                // HDMPHead ^^
                part = new Part(3467, "HDMPHead", this, 1, (trackHelper.DoorPanelWidth * 3) - (stileWidth) - (pocketInset) + (jamB) + (doorGap));
                part.PartGroupType = "Frame-Parts";
                part.PartLabel = "";
