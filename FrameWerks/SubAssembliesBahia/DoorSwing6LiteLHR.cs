...
namespace FrameWorks.Makes.Bahia
{
    ...
    public class DoorSwing6LiteLHR : SubAssemblyBase
    {
        ...
        public DoorSwing6LiteLHR()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "Bahia-DoorSwing6LiteLHR";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 6; i++)
            {
                ...
                rectSeal = (m_subAssemblyWidth - 2 * glassDrGap - 2 * glassMuntGap) / 2.0m * 2.0m;
                rectSeal += (m_subAssemblyHieght - 2 * glassDrGap - 4 * glassMuntGap) / 3.0m * 2.0m;
                rectSeal *= 2.0m;
