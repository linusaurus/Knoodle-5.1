...
namespace FrameWorks.Makes.FFI_LS_Gears
{
    ...
    public class GearHalfCarriageX : SubAssemblyBase
    {
        ...
        public GearHalfCarriageX()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "FFI_LS_Gears-GearHalfCarriageX";
        }
        ...
        public override void Build()
        {
            ...
            part = new Part(4096, "LiftSlideHalfGear", this, 1, m_subAssemblyHieght);
