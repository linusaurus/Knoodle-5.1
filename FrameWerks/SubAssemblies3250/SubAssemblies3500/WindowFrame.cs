...
namespace FrameWorks.Makes.System3500
{
    ...
    public class WindowFrame : SubAssemblyBase
    {
        ...
        public WindowFrame()
        {
            ...
            this.ModelID = "System3500-WindowFrame";
        }
        ...
        public override void Build()
        {
            ...
            part = new Part(2900, "JambL", this, 1, m_subAssemblyHieght);
            ...
            part = new Part(2900, "JambR", this, 1, m_subAssemblyHieght);
            part.PartGroupType = "Frame-Parts";
            part.PartLabel = "1)MiterEnds";
            ...
            part = new Part(2900, "Head", this, 1, m_subAssemblyWidth);
            part.PartGroupType = "Frame-Parts";
            part.PartLabel = "1)MiterEnds";
            ...
            part = new Part(2900, "Sill", this, 1, m_subAssemblyWidth);
            part.PartGroupType = "Frame-Parts";
            part.PartLabel = "1)MiterEnds";
