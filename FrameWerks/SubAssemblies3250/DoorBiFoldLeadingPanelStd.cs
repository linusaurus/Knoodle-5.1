...
namespace FrameWorks.System3250
{
    ...
    public class DoorBiFoldLeadingPanelStd : SubAssemblyBase
    {
        ...
        public DoorBiFoldLeadingPanelStd()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System3250-DoorBiFoldLeadingPanelStd";
        ...
        public override void Build()
        {
            ...
            // HingeFlat ||
            part = new Part(3002, "HingeFlat", this, 1, 0.0m);
            ...
            // OffsetCarrier ||
            part = new Part(3001, "OffsetCarrier", this, 1, 0.0m);
            part.PartGroupType = "Hardware-Parts";
            part.PartLabel = "";
