...
namespace FrameWorks.System3250
{
    ...
    public class CasementSashRHR : SubAssemblyBase
    {
        ...
        public CasementSashRHR()
        {
            ...
            this.ModelID = "System3250-CasementSashRHR";
        }
        #endregion
        ...
        public override void Build()
        {
            ...
            part = new Part(2974, "Filler-Left", this, 1, m_subAssemblyHieght);
            part.PartGroupType = "Filler-Parts";
            part.PartLabel = "";
            
            m_parts.Add(part);

            part = new Part(2975, "Filler-Right", this, 1, m_subAssemblyHieght);
            part.PartGroupType = "Filler-Parts";
            part.PartLabel = "";
            ...
            // Lever
            part = new Part(1117, "Lever", this, 1, 0.0m);
            part.PartGroupType = "Hardware-Parts";
            part.PartLabel = "";
