...
namespace FrameWorks.Makes.System3250
{
    ...
    public class FixedLamMiterRight : SubAssemblyBase
    {
        ...
        public FixedLamMiterRight()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System3250-FixedLamMiterRight";
        }
        ...
        public override void Build()
        {
            ...
            part.ContainerAssembly = this;
            part.PartLength = m_subAssemblyWidth - (0.625m + 0.25m);
            part.FunctionalName = "FillerBrzHeadL";
            part.PartLabel = "VMiter_L_HMiter_R";
            ...
            part.ContainerAssembly = this;
            part.PartLength = m_subAssemblyDepth - (0.625m + 0.25m);
            part.FunctionalName = "FillerBrzHeadR";
            part.PartLabel = "VMiter_R_HMiter_L";
            ...
            part.ContainerAssembly = this;
            part.PartLength = m_subAssemblyWidth - (0.625m + 0.25m);
            part.FunctionalName = "FillerBrzSillL";
            part.PartLabel = "VMiter_L_HMiter_R";
            ...
            part.ContainerAssembly = this;
            part.PartLength = m_subAssemblyDepth - (0.625m + 0.25m);
            part.FunctionalName = "FillerBrzSillR";
            part.PartLabel = "VMiter_R_HMiter_L";
            ...
            //LAM_CornerDL
            part = new Part(3067);
            part.FunctionalName = "LAM_MiterHLeftt";
            part.PartGroupType = "Glass-Parts";
            part.Qnty = 1;
            part.PartName = "PartName";
