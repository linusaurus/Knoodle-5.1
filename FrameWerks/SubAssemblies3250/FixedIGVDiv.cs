...
namespace FrameWorks.System3250
{
    ...
    public class FixedIGVDiv : SubAssemblyBase
    {
        ...
        public FixedIGVDiv()
        {
            ...
            this.ModelID = "Sys3250-FixedIGVDiv";
        }
        ...
        public override void Build()
        {
            ...
            // MuntinBarExtV1 ||
            part = new Part(1859, "MuntinBarExtV1", this, 1, m_subAssemblyHieght - 1.375m * 2.0m);
            ...
            // MuntinBarExtV2 ||
            part = new Part(1859, "MuntinBarExtV2", this, 1, m_subAssemblyHieght - 1.375m * 2.0m);
            part.PartGroupType = "Muntin-Parts";
            part.PartLabel = "";
