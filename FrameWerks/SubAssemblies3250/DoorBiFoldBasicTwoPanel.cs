...
namespace FrameWorks.System3250
{
    ...
    public class DoorBiFoldBasicTwoPanel : SubAssemblyBase
    {
        ...
        public DoorBiFoldBasicTwoPanel()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System3250-DoorBiFoldBasicTwoPanel";
        ...
        public override void Build()
        {
            ...
            // HingeOffset ||
            part = new Part(3027, "HingeOffset", this, 1, 0.0m);
