...
namespace FrameWorks.Makes.System3250
{
    ...
    public class RigletVertInt : SubAssemblyBase
    {
        ...
        public RigletVertInt()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System3250-RigletVertInt";
        }
        ...
        public override void Build()
        {
            ...
            // RigletVertInt
            part = new Part(2664, "RigletVertInt", this, 1, m_subAssemblyHieght);
