...
namespace FrameWorks.System3250
{
    ...
    public class FrameDoorSwingRHR : SubAssemblyBase
    {
        ...
        public FrameDoorSwingRHR()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System3250-FrameDoorSwingRHR";
        }
        ...
        public override void Build()
        {
            ...
            // HingeTop
            part = new Part(2969, "HingeTop", this, 1, 0.0m);
            ...
            // HingeMid
            part = new Part(2969, "HingeMid", this, 1, 0.0m);
            part.PartGroupType = "Hardware-Parts";
            part.PartLabel = "";
            ...
            // HingeBot
            part = new Part(2969, "HingeBot", this, 1, 0.0m);
            part.PartGroupType = "Hardware-Parts";
            part.PartLabel = "";
            ...
            // StrikePlate
            part = new Part(1947, "StrikePlate", this, 1, 0.0m);
            part.PartGroupType = "Hardware-Parts";
            part.PartLabel = "";
            ...
            part = new LPart("PatinaMat",this,this.m_subAssemblyHieght * 2.0m + m_subAssemblyWidth, 0.41m);
            m_parts.Add(part);
            //$0.41 per inch
