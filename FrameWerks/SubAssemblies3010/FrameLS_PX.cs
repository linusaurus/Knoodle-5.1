...
namespace FrameWorks.Makes.System3010
{
    ...
    public class FrameLS_PX : SubAssemblyBase
    {
        ...
        const decimal yTrackPocket = 4.00m;
        ...
        public override void Build()
        {
            ...
            //TopTrackYX
            part = new Part(3406, "TopTrackYX", this, 1, m_subAssemblyWidth * 2.0m + yTrackPocket + doorGap);
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                part = new Part(4363, "BzJambMODIFYStrike", this, 1, m_subAssemblyHieght - calkGap);
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                part = new Part(4364, "BzFaciaHead", this, 1, m_subAssemblyWidth - jambInsetX2);
                part.PartGroupType = "Frame-Parts";
                part.PartLabel = "";
