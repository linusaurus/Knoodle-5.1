...
namespace FrameWorks.Makes.System3010
{
    ...
    public class FixedLM9Lt : SubAssemblyBase
    {
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 4; i++)
            {
                part = new Part(4313, "BrzMntHrz9Lt", this, 1, m_subAssemblyWidth - muntReduceX2);
            ...
            for (int i = 0; i < 4; i++)
            {
                part = new Part(4313, "BrzMntVrt9Lt_UP", this, 1, muntinUpper);
                part.PartGroupType = "Muntin_1-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
                part.PartLabel = "";
            ...
            for (int i = 0; i < 4; i++)
            {
                part = new Part(4313, "BrzMntVrt9Lt_MID", this, 1, muntinMiddle);
                part.PartGroupType = "Muntin_1-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
                part.PartLabel = "";
            ...
            for (int i = 0; i < 4; i++)
            {
                part = new Part(4313, "BrzMntVrt9Lt_LOW", this, 1, muntinLower);
                part.PartGroupType = "Muntin_1-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
                part.PartLabel = "";
