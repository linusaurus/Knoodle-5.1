...
{
    public class Slide_X_DrMid_D : SubAssemblyBase
    {
        ...
        public Slide_X_DrMid_D()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "MonacoCoveSS-Slide_X_DrMid_D";
        ...
        public override void Build()
        {
            ...
            // 316SSClad StileExtRight 4173
            for (int i = 0; i < 2; i++)
            {
                part = new Part(4173, "StileClad", this, 1, m_subAssemblyHieght);
            ...
            // 316SSClad StileExtLeft 4175
            for (int i = 0; i < 1; i++)
            {
                part = new Part(4175, "StileClad", this, 1, m_subAssemblyHieght);
                part.PartGroupType = "316SSClad-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
                part.PartLabel = labelStileL = "MiterEnds";
