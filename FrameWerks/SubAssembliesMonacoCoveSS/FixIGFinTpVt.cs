...
namespace FrameWorks.Makes.MonacoCoveSS
{
    ...
    public class FixIGFinTpVt : SubAssemblyBase
    {
        ...
        public FixIGFinTpVt()
        {
            ...
            this.ModelID = "MonacoCoveSS-FixIGFinTpVt";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(4074, "AlumFixIGVertNOFIN", this, 1, m_subAssemblyHieght + 2.0m * finToFin);
                part.PartGroupType = "FrameAlum-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
                part.PartLabel = "";
