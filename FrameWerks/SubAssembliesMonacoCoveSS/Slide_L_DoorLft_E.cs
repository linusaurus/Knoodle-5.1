...
{
    public class Slide_L_DoorLft_E : SubAssemblyBase
    {
        ...
        public Slide_L_DoorLft_E()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "MonacoCoveSS-Slide_L_DoorLft_E";
        ...
        public override void Build()
        {
            ...
            // 316SSClad StileHookClad 4174

            for (int i = 0; i < 1; i++)
            {
                part = new Part(4174, "StileHookClad", this, 1, m_subAssemblyHieght);
            ...
            // 316SSClad StileExtRight 4176
            for (int i = 0; i < 1; i++)
            {
                part = new Part(4176, "StileClad", this, 1, m_subAssemblyHieght);
                part.PartGroupType = "316SSClad-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
            ...
            // 316SSClad StileExtRight 4177
            for (int i = 0; i < 2; i++)
            {
                part = new Part(4177, "StileClad", this, 1, m_subAssemblyHieght);
                part.PartGroupType = "316SSClad-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
                part.PartLabel = labelStileL = "MiterEnds";
