...
{
    public class Slide_O_DrRit_D : SubAssemblyBase
    {
        ...
        public Slide_O_DrRit_D()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "MonacoCoveSS-Slide_O_DrRit_D";
        ...
        public override void Build()
        {
            ...
            // 316SSClad StileExtHook 4174
            for (int i = 0; i < 1; i++)
            {
                part = new Part(4174, "StileExtHook", this, 1, m_subAssemblyHieght);
                part.PartGroupType = "316SSClad-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
