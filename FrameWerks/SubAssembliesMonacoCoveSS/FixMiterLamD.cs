...
namespace FrameWorks.Makes.MonacoCoveSS
{
    ...
    public class FixMiterLamD : SubAssemblyBase
    {
        ...
        public FixMiterLamD()
        {
            ...
            this.ModelID = "MonacoCoveSS-FixMiterLamD";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(4142, "AlumFixLamHorz<|", this, 1, m_subAssemblyDepth + finToFin);
                part.PartGroupType = "FrameAlum-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
            ...
            for (int i = 0; i < 1; i++)
            {
                part = new Part(4073, "GlassStopTop2<|", this, 1, m_subAssemblyDepth - stopReduce - stopRedMit);
                part.PartGroupType = "StopGls-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
                part.PartLabel = "DepthMiter1Vert";
            ...
            for (int i = 0; i < 1; i++)
            {
                ...
                string crap;
                crap = FrameWorks.Functions.StopWeepMachining(m_subAssemblyDepth - stopReduce - stopRedMit);
                part = new Part(4073, "GlassStopBot2<|", this, 1, m_subAssemblyDepth - stopReduce - stopRedMit);
                part.PartGroupType = "StopGls-Parts";
                part.PartLabel = "1)DepthMiter1Vert" + "\r\n" +
                                 "2)" + crap;
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(4165, "FLam_SS_Clad_Horz", this, 1, m_subAssemblyDepth);
                part.PartGroupType = "316SS_Clad_BB_Fin-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
                part.PartLabel = "DepthMiterEXT2";
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(4165, "FLam_SS_Clad_Horz", this, 1, m_subAssemblyDepth - cladMtrRed);
                part.PartGroupType = "316SS_Clad_BB_Fin-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
                part.PartLabel = "DepthMiterINT2";
            ...
            part.PartWidth = m_subAssemblyDepth - glassReduce - glsMtrRed;
            part.PartLength = m_subAssemblyHieght - glassReduce * 2.0m;
            part.PartThick = 0.5625m;
            part.PartLabel = "FlatPolishMIter**PATTERN**";
