...
{
    public class Slide_O_DrLft_D : SubAssemblyBase
    {
        ...
        public Slide_O_DrLft_D()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "MonacoCoveSS-Slide_O_DrLft_D";
        ...
        public override void Build()
        {
            ...
            // 316SSClad StileExtRight 4187
            for (int i = 0; i < 1; i++)
            {
                part = new Part(4187, "StileExtRight", this, 1, m_subAssemblyHieght);
                part.PartGroupType = "316SSClad-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
                part.PartLabel = labelStileL = "MiterEnds";
            ...
            // 316SSClad StileIntRight 4186
            for (int i = 0; i < 1; i++)
            {
                part = new Part(4186, "StileIntRight", this, 1, m_subAssemblyHieght);
                part.PartGroupType = "316SSClad-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
