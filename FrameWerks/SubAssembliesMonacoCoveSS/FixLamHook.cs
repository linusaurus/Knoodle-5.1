...
namespace FrameWorks.Makes.MonacoCoveSS
{
    ...
    public class FixLamHook : SubAssemblyBase
    {
        ...
        public FixLamHook()
        {
            ...
            this.ModelID = "MonacoCoveSS-FixLamHook";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(4142, "AlumFixLamNOFIN", this, 1, m_subAssemblyHieght + 2.0m * finToFin);
            ...
            part.PartWidth = m_subAssemblyWidth - (glassReduce + glsRedHook);
