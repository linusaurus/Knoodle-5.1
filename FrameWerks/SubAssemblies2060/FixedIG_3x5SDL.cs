    ...
    public class FixedIG_3x5SDL : SubAssemblyBase
    {
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 24; i++)
            {
                ...
                Component = new Component(5306, "MuntHorz", this, 1, (m_subAssemblyWidth - MuntGapX2) / 3.0m);
            ...
            for (int i = 0; i < 20; i++)
            {
                ...
                Component = new Component(5306, "MuntVert", this, 1, (m_subAssemblyHieght - MuntGapX2) / 5.0m);
                Component.ComponentGroupType = "Muntins";
                Component.ComponentLabel = "?_Ends";
