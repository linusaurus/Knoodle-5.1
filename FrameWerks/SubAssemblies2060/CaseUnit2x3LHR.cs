    ...
    public class CaseUnit2x3LHR : SubAssemblyBase
    {
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 6; i++)
            {
                ...
                Component = new Component(4588, "MuntVert", this, 1, (m_subAssemblyHieght - MuntGapX2) / 3.0m);
                Component.ComponentGroupType = "Muntins";
                Component.ComponentLabel = "?_Ends";
            ...
            for (int i = 0; i < 2; i++)
            {
                Component = new Component(5124, "AlumGlsStpVert", this, 1, m_subAssemblyHieght - gstopReduce2X);
            ...
            for (int i = 0; i < 2; i++)
            {
                Component = new Component(5124, "AlumGlsStpTopBot", this, 1, m_subAssemblyWidth - gstopReduce2X);
                Component.ComponentGroupType = "StopAlum-Components";
                Component.ComponentWidth = Component.Source.Width;
                Component.ComponentThick = Component.Source.Height;
                Component.ComponentLabel = "";
