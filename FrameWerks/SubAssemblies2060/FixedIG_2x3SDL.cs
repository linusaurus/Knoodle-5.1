    ...
    public class FixedIG_2x3SDL : SubAssemblyBase
    {
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 6; i++)
            {
                ...
                Component = new Component(5306, "MuntVert", this, 1, (m_subAssemblyHieght - MuntGapX2) / 3.0m);
                Component.ComponentGroupType = "Muntins";
            ...
            for (int i = 0; i < 12; i++)
            {
                ...
                Component = new Component(911, "EPDM_Wedge", this, 1,( m_subAssemblyHieght - MuntGapX2) / 3.0m);
                Component.ComponentGroupType = "Seal-Components";
                Component.ComponentLabel = "";
