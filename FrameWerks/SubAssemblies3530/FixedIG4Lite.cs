...
namespace FrameWorks.Makes.System3530
{
    ...
    public class FixedIG4Lite : SubAssemblyBase
    {
        ...
        public FixedIG4Lite()
        {
            ...
            this.ModelID = "System3530-FixedIG4Lite";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 4; i++)
            {
                part = new Part(3893, "BrzMuntinVert", this, 1, (m_subAssemblyHieght - muntFrmRedX2 - muntinJunc) / 2.0m);
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(911, "DelrinDivVert", this, 1, (m_subAssemblyHieght - delReduceX2 - delRenThick) / 2.0m);
                part.PartGroupType = "Muntin-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
                part.PartLabel = "";
