...
namespace FrameWorks.Makes.System3530
{
    ...
    public class DrSwg10LtSHwrLHR : SubAssemblyBase
    {
        ...
        public DrSwg10LtSHwrLHR()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System3530-DrSwg10LtSHwrLHR";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                part = new Part(3893, "BrzMntVrt8Lt", this, 1, (m_subAssemblyHieght - muntStileRedX2 - 4.0m * muntJuncRed) / 5.0m);
            ...
            for (int i = 0; i < 5; i++)
            {
                part = new Part(911, "DlrnDivVrt8Lt", this, 1, (m_subAssemblyHieght - 2.0m * dlrnStlRed - 4.0m * delrinThick) / 5.0m);
                part.PartGroupType = "Muntin-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
                part.PartLabel = "";
            ...
            for (int i = 0; i < 10; i++)
            {
                ...
                //Glass10Lite5Lower
                part = new Part(4420);
                part.FunctionalName = "Glass8Lite10";
                part.PartGroupType = "Glass-Parts";
                part.Qnty = 1;
                part.ContainerAssembly = this;
                part.PartWidth = ((m_subAssemblyWidth - 2.0m * glassDrGap - glassMuntRedX2) / 2);
                part.PartLength = ((m_subAssemblyHieght - 2.0m * glassDrGap - 4.0m * glassMuntRedX2) / 5);
                part.PartThick = 1.0m;
