...
namespace FrameWorks.Makes.System3530
{
    ...
    public class SashCaseHM3LtLHRpass : SubAssemblyBase
    {
        ...
        public SashCaseHM3LtLHRpass()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System3530-SashCaseHM3LtLHRpass";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 4; i++)
            {
                part = new Part(3893, "BrzMntHrz3Lt", this, 1, m_subAssemblyWidth - muntSashRedX2);
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(911, "DlrnDivHrz3Lt", this, 1, m_subAssemblyWidth - delReduceX2);
                part.PartGroupType = "Muntin-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
                part.PartLabel = "";
