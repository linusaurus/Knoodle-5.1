...
namespace FrameWorks.Makes.System3530
{
    ...
    public class FrameSwingPairEllips : SubAssemblyBase
    {
        ...
        public FrameSwingPairEllips()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System3530-FrameSwingPairEllips";
        }
        ...
        public override void Build()
        {
            ...
            // HeadBrzPrStrechFormed ^^
            part = new Part(3948, "HeadBrzPrStrechFormed", this, 1, 76.0000m);
            part.PartGroupType = "Frame-Parts";
