...
namespace FrameWorks.Makes.System3530
{
    ...
    public class DrSwg8LtOvr26PanActLH : SubAssemblyBase
    {

        #region Fields

        // The values we can change for different layouts
        const decimal BrzPanelSwgDr = 26.77747464m;
        const decimal muntBzPnlRed = 27.91763969m;
        const decimal dlrnPnlRed = 28.02668m;
        const decimal muntStileRedX2 = 1.53062108m;
        const decimal muntStileRed = 0.76531054m;
        const decimal dlrnStlRed = 0.725523m;
        ...
        const decimal brzLowPanRed = 26.90245055m;
        ...
        public DrSwg8LtOvr26PanActLH()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System3530-DrSwg8LtOvr26PanActLH";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 1; i++)
            {
                part = new Part(4072, "VertBump", this, 1, (m_subAssemblyHieght - brzLowPanRed - 2 * brzLowproStep - 4 * muntStepRed) / 4);
            ...
            for (int i = 0; i < 1; i++)
            {
                ...
                //Gls8LtHrd1
                part = new Part(4420);
                part.FunctionalName = "Gls8LtHrd1";
                part.PartGroupType = "Glass-Parts";
                part.Qnty = 1;
                part.ContainerAssembly = this;
                part.PartWidth = ((m_subAssemblyWidth - 2.0m * glassDrGap - glassMuntRedX2) / 2) - hrdwrBupRed;
                part.PartLength = ((m_subAssemblyHieght - BrzPanelSwgDr - 2.0m * glassDrGap - 4.0m * glassMuntRedX2) / 4.0m);
                part.PartThick = 1.0m;
            ...
            for (int i = 0; i < 7; i++)
            {
                ...
                //Gls10LtLow7
                part = new Part(4420);
                part.FunctionalName = "Gls8LtLow7";
                part.PartGroupType = "Glass-Parts";
                part.Qnty = 1;
                part.ContainerAssembly = this;
