...
{
    [Serializable()]
    public class NailFin2HzMtr1End : SubAssemblyBase
    {
        ...
        public NailFin2HzMtr1End()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System3530-NailFin2HzMtr1End";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(3649, "NailerMtrExt1<|", this, 1, m_subAssemblyWidth + nailFinAd);
                part.PartGroupType = "NailFin-Parts";
                part.PartLabel = "1)Miter1End1<|";
