...
namespace FrameWorks.Makes.System3530
{
    ...
    public class FixIG4LtOvrPan : SubAssemblyBase
    {
        ...
        const decimal brzSidelitePan = 6.8750m;
        const decimal glassBzPnlRed = 7.8125m;
        const decimal glassTopRed = 20.35939306m;
        const decimal glassUpper = 19.04689306m;
        //
        ...
        public FixIG4LtOvrPan()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System3530-FixIG4LtOvrPan";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 1; i++)
            {
                ...
                part.FunctionalName = "Glass4LiteTop";
            ...
            for (int i = 0; i < 3 ; i++)
            {
                ...
                part.FunctionalName = "Glass4LiteMids";
                part.PartGroupType = "Glass-Parts";
                part.Qnty = 1;
                part.ContainerAssembly = this;
                part.PartWidth = (m_subAssemblyWidth - 2 * glassReduce);
                part.PartLength = ((m_subAssemblyHieght- glassTopRed  - 3.0m * glassMuntRedX2 - glassBzPnlRed ) / 3);
                part.PartThick = 1.0m;
