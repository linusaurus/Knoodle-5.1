...
namespace FrameWorks.Makes.System3530
{
    ...
    public class DoorBrzCld_LS_RearPX : SubAssemblyBase
    {
        ...
        public DoorBrzCld_LS_RearPX()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System3530-DoorBrzCld_LS_RearPX";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                part = new Part(1005, "Edge & Bottom Seal", this, 1, m_subAssemblyWidth);
                part.PartGroupType = "Seal-Parts";
                part.PartLabel = "";
