...
namespace FrameWorks.Makes.System3530
{
    ...
    public class DrSwg10Lt16PanPasRHR : SubAssemblyBase
    {
        ...
        const decimal muntBzPnlRed = 7.06259972m;
        const decimal dlrnPnlRed = 7.29687472m;
        const decimal muntStileRedX2 = 1.53062102m;
        const decimal muntStileRed = 0.76531051m;
        const decimal dlrnStlRed = 0.72552309m;
        const decimal muntJuncRed = .15533011m;            
        const decimal glassMuntRedX2 = .375m;
        const decimal glassDrGap = 0.875m;   
        const decimal epdmReduce = .85888609m;
        ...
        public DrSwg10Lt16PanPasRHR()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System3530-DrSwg10Lt16PanPasRHR";
        }
