...
namespace FrameWorks.Makes.System3530
{
    ...
    public class SashCaseHVM6LtLHRpass : SubAssemblyBase
    {
        ...
        public SashCaseHVM6LtLHRpass()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System3530-SashCaseHVM6LtLHRpass";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 6; i++)
            {
                part = new Part(3893, "BrzMntVrt6Lt", this, 1, (m_subAssemblyHieght - muntSashRedX2 - 2 * muntJuncRed) / 3.0m);
            ...
            for (int i = 0; i < 3; i++)
            {
                part = new Part(911, "DlrnDivVrt6Lt", this, 1, (m_subAssemblyHieght - delReduceX2 - 2.0m * delrinThick) / 3.0m);
                part.PartGroupType = "Muntin-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
                part.PartLabel = "";
            ...
            for (int i = 0; i < 4; i++)
            {
                part = new Part(3893, "BrzMntHrz6Lt", this, 1, m_subAssemblyWidth - muntSashRedX2);
                part.PartGroupType = "Muntin-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
                part.PartLabel = "";
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(911, "DlrnDivHrz6Lt", this, 1, m_subAssemblyWidth - delReduceX2);
                part.PartGroupType = "Muntin-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
                part.PartLabel = "";
            ...
            for (int i = 0; i < 6; i++)
            {
                ...
                part.FunctionalName = "Glass6Lite";
