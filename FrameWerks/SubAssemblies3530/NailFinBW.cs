...
{
    [Serializable()]
    public class NailFinBW : SubAssemblyBase
    {
        ...
        public NailFinBW()
        {
            ...
            this.ModelID = "System3530-NailFinBW";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(3649, "NailerWidthExt", this, 1, m_subAssemblyWidth + nailFinAd);
                part.PartGroupType = "NailFin-Parts";
                part.PartLabel = "1)Miter_BLOCK";
