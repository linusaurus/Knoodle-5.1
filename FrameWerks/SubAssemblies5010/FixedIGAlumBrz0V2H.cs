...
namespace FrameWorks.Makes.System5010
{
    ...
    public class FixedIGAlumBrz0V2H : SubAssemblyBase
    {
        ...
        const decimal glasAtMuntX2 = 0.125m * 2.0m;
        ...
        public FixedIGAlumBrz0V2H()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System5010-FixedIGAlumBrz0V2H";
        }
        ...
        public override void Build()
        {
            ...
            //for (int i = 0; i < 0; i++)
            //{
                //part = new Part(911, "WoodFixWndVert", this, 1, m_subAssemblyHieght);
            ...
            part.PartWidth = m_subAssemblyWidth - (glasAtMuntX2);
