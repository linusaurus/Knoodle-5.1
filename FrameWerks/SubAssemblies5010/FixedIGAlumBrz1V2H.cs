...
namespace FrameWorks.Makes.System5010
{
    ...
    public class FixedIGAlumBrz1V2H : SubAssemblyBase
    {

        #region Fields

        //Constant Values
        const decimal stopReduce = 0625m;
        ...
        public FixedIGAlumBrz1V2H()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System5010-FixedIGAlumBrz1V2H";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(4298, "BrzGlsStpHz", this, 1, m_subAssemblyWidth - stopReduce);
                part.PartGroupType = "StopBrz-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
                part.PartLabel = "";
            ...
            part.PartWidth = m_subAssemblyWidth - (glassAtMunt + glassReduce);
