...
namespace FrameWorks.Makes.System5010
{
    ...
    public class FixedIG1_5_Hvy_BrzAlum : SubAssemblyBase
    {
        ...
        public FixedIG1_5_Hvy_BrzAlum()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System5010-FixedIG1_5_Hvy_BrzAlum";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(4552, "BrzAluFixVert", this, 1, m_subAssemblyHieght);
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(4552, "BrzAlumFixHorz", this, 1, m_subAssemblyWidth);
                part.PartGroupType = "FrameBrzAlu-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
                part.PartLabel = "";
