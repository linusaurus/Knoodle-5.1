...
{
    [Serializable()]
    public class SubFrame7_HzHlfCap_2 : SubAssemblyBase
    {
        ...
        const decimal HalfcapReduce = 1.0975m / 2.0m;
        ...
        public SubFrame7_HzHlfCap_2()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "TiburBronze-SubFrame7_HzHlfCap_2";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 4; i++)
            {
                part = new Part(3694, "CapBronzeHorz", this, 1, m_subAssemblyWidth - HalfcapReduce);
