...
{
    [Serializable()]
    public class Frame_7_Brz_FixedIG : SubAssemblyBase
    {
        ...
        public Frame_7_Brz_FixedIG()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "TiburBronze-Frame_7_Brz_FixedIG";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 4; i++)
            {
                part = new Part(3695, "BronzeHorz", this, 1, m_subAssemblyWidth - centerReduce * 2.0m);
