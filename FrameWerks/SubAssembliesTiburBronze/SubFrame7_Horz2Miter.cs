...
{
    [Serializable()]
    public class SubFrame7_Horz2Miter : SubAssemblyBase
    {
        ...
        public SubFrame7_Horz2Miter()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "TiburBronze-SubFrame7_Horz2Miter";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(3074, "SubFrameHorz|>", this, 1, m_subAssemblyWidth - subReduce);
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(3074, "SubFrameHorz|>", this, 1, m_subAssemblyDepth - subReduce);
                part.PartGroupType = "SubFrameAssy-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
                part.PartLabel = "";
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(3694, "CapBronzeHorzExt<>", this, 1, m_subAssemblyWidth);
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(3694, "CapBronzeHorzInt><", this, 1, m_subAssemblyWidth - capReMiter);
                part.PartGroupType = "CapAssy-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
                part.PartLabel = "";
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(3694, "CapBronzeHorzExt<>", this, 1, m_subAssemblyDepth);
                part.PartGroupType = "CapAssy-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
                part.PartLabel = "";
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(3694, "CapBronzeHorzInt><", this, 1, m_subAssemblyDepth - capReMiter);
                part.PartGroupType = "CapAssy-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
                part.PartLabel = "";
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(2421, "MullingTenExt", this, 1, m_subAssemblyDepth);
                part.PartGroupType = "MullingTennon-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
                part.PartLabel = "";
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(2421, "MullingTenInt", this, 1, m_subAssemblyDepth - capReMiter);
                part.PartGroupType = "MullingTennon-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
                part.PartLabel = "";
