...
{
    [Serializable()]
    public class SubFrame7Horz_1_Mid : SubAssemblyBase
    {

        #region Fields

        //Constant Values
        const decimal subReduce = .25m;
        const decimal capReduce = 1.0975m;
        const decimal halfCapReduce = 0.54875m;
        ...
        public SubFrame7Horz_1_Mid()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "TiburBronze-SubFrame7Horz_1_Mid";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(2421, "MullingTennon", this, 1, m_subAssemblyWidth - capReduce);
