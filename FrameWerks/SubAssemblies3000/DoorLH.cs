...
namespace FrameWorks.Makes.System3000
{
    ...
    public class DoorLH : SubAssemblyBase
    {
        ...
        public override void Build()
        {
            ...
            // StopHandleFront
            part = new Part(809, "StopHandleFront", this, 1, 11.75m);
            part.PartGroupType = "Stop-Parts";
            ...
            // StopHandleRear
            part = new Part(809, "StopHandleRear", this, 1, 11.75m);
            part.PartGroupType = "Stop-Parts";
            part.PartLabel = "MiterOuterBoth";
