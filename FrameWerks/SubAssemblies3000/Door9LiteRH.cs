...
namespace FrameWorks.Makes.System3000
{
    ...
    public class Door9LiteRH : SubAssemblyBase
    {
        ...
        public Door9LiteRH()
        {
            ...
            this.ModelID = "Sys3000-Door9LiteRH";
        ...
        public override void Build()
        {
            ...
            // MuntinBarExtV1 ||
            part = new Part(1859, "MuntinBarExtV1", this, 1, m_subAssemblyHieght - 2.0m * 2.0625m);
            ...
            // MuntinBarExtV2 ||
            part = new Part(1859, "MuntinBarExtV2", this, 1, m_subAssemblyHieght - 2.0m * 2.0625m);
            part.PartGroupType = "Muntin-Parts";
            part.PartLabel = "";
            ...
            // MuntinBarIntV1 ||
            part = new Part(1859, "MuntinBarIntV1", this, 1, m_subAssemblyHieght - 2.0m * 2.0625m);
            part.PartGroupType = "Muntin-Parts";
            part.PartLabel = "";
            ...
            // MuntinBarIntV2 ||
            part = new Part(1859, "MuntinBarIntV2", this, 1, m_subAssemblyHieght - 2.0m * 2.0625m);
            part.PartGroupType = "Muntin-Parts";
            part.PartLabel = "";
            ...
            // MuntinBarExtH1 <-->
            part = new Part(2757, "MuntinBarExtH1", this, 1, m_subAssemblyWidth - (3.375m + 2.0625m));
            part.PartGroupType = "Muntin-Parts";
            part.PartLabel = "";
            ...
            // MuntinBarExtH2 <-->
            part = new Part(2757, "MuntinBarExtH2", this, 1, m_subAssemblyWidth - (3.375m + 2.0625m));
            part.PartGroupType = "Muntin-Parts";
            part.PartLabel = "";
            ...
            // MuntinBarIntH1 <-->
            part = new Part(2757, "MuntinBarIntH1", this, 1, m_subAssemblyWidth - (3.375m + 2.0625m));
            part.PartGroupType = "Muntin-Parts";
            part.PartLabel = "";
            ...
            // MuntinBarIntH2 <-->
            part = new Part(2757, "MuntinBarIntH2", this, 1, m_subAssemblyWidth - (3.375m + 2.0625m));
            part.PartGroupType = "Muntin-Parts";
            part.PartLabel = "";
            ...
            // Foam Tape Vertical ||  #2808
            part = new Part(2808, "FoamTape", this, 4, m_subAssemblyWidth - (3.375m + 2.0625m));
            part.PartGroupType = "FoamTape-Parts";
            part.PartLabel = "";
