...
namespace FrameWorks.Makes.System3000
{
    ...
    public class FixedDivPanel : SubAssemblyBase
    {
        ...
        public FixedDivPanel()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "Sys3000-FixedDivPanel";
        ...
        public override void Build()
        {
            ...
            // MuntinBarExtV3 ||
            part = new Part(2987, "MuntinBarExtV3", this, 1, m_subAssemblyHieght - 1.3125m * 2.0m);
            part.PartGroupType = "Muntin-Parts";
            part.PartLabel = "";
            ...
            // MuntinBarIntV3 ||
            part = new Part(2987, "MuntinBarIntV3", this, 1, m_subAssemblyHieght - 1.3125m * 2.0m);
            part.PartGroupType = "Muntin-Parts";
            part.PartLabel = "";
            ...
            // MuntinBarExtH5 <-->
            part = new Part(2987, "MuntinBarExtH5", this, 1, m_subAssemblyWidth - 1.3125m * 2.0m);
            part.PartGroupType = "Muntin-Parts";
            part.PartLabel = "";
            ...
            // MuntinBarIntH5 <-->
            part = new Part(2987, "MuntinBarIntH5", this, 1, m_subAssemblyWidth - 1.3125m * 2.0m);
            part.PartGroupType = "Muntin-Parts";
            part.PartLabel = "";
