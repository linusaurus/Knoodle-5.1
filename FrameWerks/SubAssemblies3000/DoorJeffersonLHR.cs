...
namespace FrameWorks.Makes.System3000
{
   ...
   public class DoorJeffersonLHR : SubAssemblyBase
   {
      ...
      public override void Build()
      {
         ...
         // StopFrontRight
         part = new Part(809, "StopFrontRight", this, 1, m_jeffersonModel.UpperSection - (1.3125m * 2.0m));
         ...
         // StopRearRight
         part = new Part(809, "StopRearRight", this, 1, m_jeffersonModel.UpperSection - (1.3125m * 2.0m));
         part.PartGroupType = "Stop-Parts";
         part.PartLabel = "";
         ...
         // StopFrontLeft
         part = new Part(809, "StopFrontLeft", this, 1, m_jeffersonModel.UpperSection - (1.3125m * 2.0m));
         part.PartGroupType = "Stop-Parts";
         part.PartLabel = "";
         ...
         // StopRearLeft
         part = new Part(809, "StopRearLeft", this, 1, m_jeffersonModel.UpperSection - (1.3125m * 2.0m));
         part.PartGroupType = "Stop-Parts";
         part.PartLabel = "";
         ...
         // StopLowerFrontTop
         part = new Part(809, "StopLowerFrontTop", this, 1, m_subAssemblyWidth - (1.3125m * 2.0m));
         part.PartGroupType = "Stop-Parts";
         part.PartLabel = "";
         ...
         // StopLowerRearTop
         part = new Part(809, "StopLowerRearTop", this, 1, m_subAssemblyWidth - (1.3125m * 2.0m));
         part.PartGroupType = "Stop-Parts";
         part.PartLabel = "";
         ...
         // StopBot
         part = new Part(809, "StopBot", this, 1, m_subAssemblyWidth - (1.3125m * 3.0m));
         part.PartGroupType = "Stop-Parts";
         part.PartLabel = "";
         ...
         // StopLeftLow
         part = new Part(809, "StopLeftLow", this, 1, (m_subAssemblyHieght - m_jeffersonModel.UpperSection) - 1.3125m);
         part.PartGroupType = "Stop-Parts";
         part.PartLabel = "";
