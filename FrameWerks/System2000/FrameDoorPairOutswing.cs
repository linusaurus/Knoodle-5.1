...
namespace FrameWorks.Makes.System2000
{
    ...
    public class FrameDoorPairOutswing : SubAssemblyBase
    {
        ...
        public FrameDoorPairOutswing()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "Sys2000-FrameDoorPairOutswing";
        }
        ...
        public override void Build()
        {
            ...
            part = new LPart("FinishHours", this,(this.Area * 0.025m) + 2.0m, 80.0m);
            this.m_parts.Add(part);
