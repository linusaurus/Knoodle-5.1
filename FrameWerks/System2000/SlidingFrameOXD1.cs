...
namespace FrameWorks.Makes.System2000
{
    ...
    public class SlidingFrameOXD1 : SubAssemblyBase
    {
        ...
        public SlidingFrameOXD1()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "SlidingFrameOXD1";
        }
        ...
        public override void Build()
        {
            ...
            // SplitHead
            part = new Part(799, "SplitHead", this, 2, m_subAssemblyWidth - 0.0625m - 0.625m);
            part.PartGroupType = "Frame-Parts";
            part.PartLabel = "";
            ...
            // SplitJamb
            part = new Part(799, "SplitJamb", this, 2, m_subAssemblyHieght);
            part.PartGroupType = "Frame-Parts";
            part.PartLabel = "";
