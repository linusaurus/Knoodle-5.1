...
namespace FrameWorks.Makes.System2000
{
    ...
    public class DoorDoubleLatchNarrowLHR : SubAssemblyBase
    {
        ...
        public DoorDoubleLatchNarrowLHR()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "Sys2000-DoorDoubleLatchNarrowLHR";
        }
        ...
        public override void Build()
        {
            ...
            part = new Part(1816, "Euro EdgeR", this, 1, m_subAssemblyHieght + (0.125m));
            part.PartGroupType = "Edge-Parts";
            part.PartLabel = "";
