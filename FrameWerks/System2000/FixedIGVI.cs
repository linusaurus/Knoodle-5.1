...
namespace FrameWorks.Makes.System2000
{
    ...
    public class FixedIGVI : SubAssemblyBase
    {
        ...
        public FixedIGVI()
        {
            ...
            this.ModelID = "Sys2000-FixedIGVI";
        }
        ...
        public override void Build()
        {
            ...
            part = new Part(2741, "MuntinHorz", this, 4, m_subAssemblyWidth - (1.375m * 2.0m) );
            ...
            part = new Part(2742, "FoamTape", this, 4, m_subAssemblyWidth - (1.375m * 2.0m));
