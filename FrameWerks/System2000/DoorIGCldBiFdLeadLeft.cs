...
namespace FrameWorks.Makes.System2000
{
    ...
    public class DoorIGCldBiFdLeadLeft : SubAssemblyBase
    {
        ...
        public DoorIGCldBiFdLeadLeft()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "Sys2000-DoorIGCldBiFdLeadLeft";
        }
        ...
        public override void Build()
        {
            ...
            // LeftCarrierSet ||
            part = new Part(3162, "LeftCarrierSet", this, 1, 0.0m);
