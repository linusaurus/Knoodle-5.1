...
namespace FrameWorks.Makes.System2000
{
    ...
    public class FixedIGIII : SubAssemblyBase
    {
        ...
        public FixedIGIII()
        {
            ...
            this.ModelID = "Sys2000-FixedIGIII";
        }
        ...
        public override void Build()
        {
            ...
            part = new Part(2741, "MuntinVert", this, 2, m_subAssemblyHieght - (1.375m * 2.0m));
            ...
            part = new Part(2741, "MuntinHorz", this, 8, (m_subAssemblyWidth - 4.25m) / 2.0m);
            part.PartGroupType = "Muntin-Parts";
            part.PartLabel = "SquareEnds";
            ...
            part = new Part(2742, "FoamTape", this, 2, m_subAssemblyHieght - (1.375m * 2.0m));
            ...
            part = new Part(2742, "FoamTape", this, 8, (m_subAssemblyWidth - 4.25m) / 2.0m);
            part.PartGroupType = "FoamTape-Parts";
            part.PartLabel = "";
            ...
            //Glass Panel
            part = new Part(-1);
            part.FunctionalName = "GlassBluPrt";
            part.PartGroupType = "GlassBluPrt-Parts";
            part.Qnty = 2;
