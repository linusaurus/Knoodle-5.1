...
namespace FrameWorks.Makes.System2000
{
    ...
    public class FixedIGII : SubAssemblyBase
    {
        ...
        public FixedIGII()
        {
            ...
            this.ModelID = "Sys2000-FixedIGII";
        }
        ...
        public override void Build()
        {
            ...
            part = new Part(2741, "MuntinHorz", this, 4, (m_subAssemblyWidth - 4.25m ) / 2.0m );
            part.PartGroupType = "Muntin-Parts";
            part.PartLabel = "SquareEnds";
            ...
            part = new Part(2742, "FoamTape", this, 4, (m_subAssemblyWidth - 4.25m) / 2.0m);
            part.PartGroupType = "FoamTape-Parts";
            part.PartLabel = "";
