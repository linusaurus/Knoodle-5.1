...
namespace FrameWorks.Makes.System2000
{
    ...
    public class DoorSlidingNarrowLeadXL : SubAssemblyBase
    {
        ...
        public DoorSlidingNarrowLeadXL()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "DoorSlidingNarrowLeadXL";
        }
        ...
        public override void Build()
        {
            ...
            // Stile Cap L <<--
            part = new Part(1001, "Cap L", this, 1, m_subAssemblyHieght);
            part.PartGroupType = "Panel-Parts";
            part.PartLabel = "";
            ...
            // TENON L <<--
            part = new Part(923, "TENON L", this, 1, m_subAssemblyHieght);
            part.PartGroupType = "Panel-Parts";
            part.PartLabel = "";
            ...
            // Hooking Cap R -->>
            part = new Part(2317, "Hooking Cap R", this, 1, m_subAssemblyHieght);
            part.PartGroupType = "Panel-Parts";
            ...
            // GLSTPLeftV 
            part = new Part(800, "GLSTPLeftV", this, 1, m_subAssemblyHieght - 2.0m * 1.3125m);
            ...
            // GLSTPRightV 
            part = new Part(800, "GLSTPRightV", this, 1, m_subAssemblyHieght - 2.0m * 1.3125m);
            part.PartGroupType = "GlassStop-Parts";
            part.PartLabel = "";
            ...
            // GLSTPTop
            part = new Part(800, "GLSTPTop", this, 1, m_subAssemblyWidth - 2.0m * 1.3125m);
            part.PartGroupType = "GlassStop-Parts";
            part.PartLabel = "";
            ...
            part = new Part(800, "GLSTPBot", this, 1, m_subAssemblyWidth - 2.0m * 1.3125m);
            part.PartGroupType = "GlassStop-Parts";
            ...
            // Assemble Braces
            part = new Part(1115, "Braces", this, 4, 0.0m);
            part.PartGroupType = "Hardware-Parts";
            part.PartLabel = "";
