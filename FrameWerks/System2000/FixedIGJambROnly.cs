...
namespace FrameWorks.Makes.System2000
{
    ...
    public class FixedIGJambROnly : SubAssemblyBase
    {
        ...
        public FixedIGJambROnly()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "Sys2000-FixedIGJambROnly";
        }
        ...
        public override void Build()
        {
            ...
            // JambLeft <<-- #926
            part = new Part(926, "JambL", this, 1, m_subAssemblyHieght);
            ...
            // JambRight -->> #2031
            part = new Part(2031, "JambR", this, 1, m_subAssemblyHieght + (2.5625m * 1.0m));
            part.PartGroupType = "Frame-Parts";
            part.PartLabel = "MiterEnds";
            ...
            part.PartWidth = m_subAssemblyWidth - ((0.9375m * 1.0m ) + (0.625m * 1.0m));
