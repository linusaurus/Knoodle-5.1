...
namespace FrameWorks.Makes.System2000
{
    ...
    public class DoorIGCldBiFdJambTwo : SubAssemblyBase
    {
        ...
        public DoorIGCldBiFdJambTwo()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "Sys2000-DoorIGCldBiFdJambTwo";
        }
        ...
        public override void Build()
        {
            ...
            // PivotSet ||
            part = new Part(3156, "PivotSet", this, 1, 0.0m);
            ...
            // FlatHingeSet ||
            part = new Part(3159, "FlatHingeSet", this, 1, 0.0m);
            part.PartGroupType = "Hardware-Parts";
            part.PartLabel = "";
            ...
            // Flushbolt ||
            part = new Part(3163, "FlushboltTop", this, 1, 0.0m);
            part.PartGroupType = "Hardware-Parts";
            part.PartLabel = "";
            ...
            // Flushbolt ||
            part = new Part(3163, "FlushboltBot", this, 1, 0.0m);
            part.PartGroupType = "Hardware-Parts";
            part.PartLabel = "";
