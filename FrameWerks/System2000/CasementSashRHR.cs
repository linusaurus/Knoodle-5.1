...
namespace FrameWorks.Makes.System2000
{
    ...
    public class CasementSashRHR : SubAssemblyBase
    {
        ...
        public CasementSashRHR()
        {
            ...
            this.ModelID = "System2000-CasementSashRHR";
        }
        ...
        public override void Build()
        {
            ...
            {
                // Casement Hinge T
                part = new Part(991, "CasementHingeT", this, 1, 0m);
                ...
                // Casement Hinge B
                part = new Part(992, "CasementHingeB", this, 1, 0m);
                part.PartGroupType = "Hardware-Parts";
                part.PartLabel = "";
            ...
            else if (pweight > 106.0m)
            {
                ...
                part = new Part(2969, "HD Hinge", this, hcount, 0m);
                part.PartGroupType = "Hardware-Parts";
                part.PartLabel = "";
