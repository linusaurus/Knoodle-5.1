...
namespace FrameWorks.Makes.System2000
{
    ...
    public class DoorIGCldBiFdJamb : SubAssemblyBase
    {
        ...
        public DoorIGCldBiFdJamb()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "Sys2000-DoorIGCldBiFdJamb";
        }
        ...
        public override void Build()
        {
            ...
            // Pivot ||
            part = new Part(3156, "Pivot", this, 1, 0.0m);
            ...
            // OffsetHingeSet ||
            part = new Part(3160, "OffsetHingeSet", this, 1, 0.0m);
            part.PartGroupType = "Hardware-Parts";
            part.PartLabel = "";
