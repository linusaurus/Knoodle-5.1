...
namespace FrameWorks.Makes.System2000
{
    ...
    public class SlidingDoorMiddleXR : SubAssemblyBase
    {
        ...
        public override void Build()
        {
            ...
            // Hooking Cap L <<--
            part = new Part(3019, "Hooking Cap L", this, 1, m_subAssemblyHieght);
            part.PartGroupType = "Panel-Parts";
            ...
            // Hooking Cap R -->>
            part = new Part(3020, "Hooking Cap R", this, 1, m_subAssemblyHieght);
            part.PartGroupType = "Panel-Parts";
            part.PartLabel = "Machine Notch 0.50m";
            ...
            this.m_parts.Add(part);
            //1 Recieve: 1 Handle: 1 CutSash:
            //1 CutGlassStop: 1.5 Machine:
            //1.5 Hardware Prep:
            //1 Mount Hardware: 4 Weld:
