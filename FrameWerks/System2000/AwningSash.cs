...
namespace FrameWorks.Makes.System2000
{
    ...
    public class AwningSash : SubAssemblyBase
    {
        ...
        public AwningSash()
        {
            ...
            this.ModelID = "System2000-AwningSash";
        ...
        public override void Build()
        {
            ...
            // Assembly Braces
            part = new Part(2674, "Assembly Braces", this, 8, 0.0m);
            ...
            part = new Part(FrameWorks.Functions.AwningHinge(SubAssemblyHieght, 'L'), "HingeL", this, 1, 0.0m);
            part.PartGroupType = "Hardware-Parts";
            part.PartLabel = "";
            ...
            part = new Part(FrameWorks.Functions.AwningHinge(SubAssemblyHieght, 'R'), "HingeR", this, 1, 0.0m);
            part.PartGroupType = "Hardware-Parts";
            part.PartLabel = "";
