...
namespace FrameWorks.Makes.System2000
{
    ...
    public class DoorIGCldBiFdBasOne : SubAssemblyBase
    {
        ...
        public DoorIGCldBiFdBasOne()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "Sys2000-DoorIGCldBiFdBasOne";
        }
        ...
        public override void Build()
        {
            ...
            // IntermediateCarrier ||
            part = new Part(3157, "IntermediateCarrier", this, 1, 0.0m);
