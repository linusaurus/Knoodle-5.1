...
namespace FrameWorks.Makes.System2000
{
    ...
    public class DoorIGCldBiFdLeadRight : SubAssemblyBase
    {
        ...
        public DoorIGCldBiFdLeadRight()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "Sys2000-DoorIGCldBiFdLeadRight";
        }
        ...
        public override void Build()
        {
            ...
            // RightCarrierSet ||
            part = new Part(3161, "RightCarrierSet", this, 1, 0.0m);
