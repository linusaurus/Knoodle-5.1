...
{
    [Serializable()]
    public class SubFrame7HorzMidMiter : SubAssemblyBase
    {
        ...
        public SubFrame7HorzMidMiter()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "TiburAlum-SubFrame7HorzMidMiter";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 1; i++)
            {
                part = new Part(3611, "CapAlumHorzIntCC", this, 1, (m_subAssemblyWidth) - capReMiter);
                part.PartGroupType = "CapAssy-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
                part.PartLabel = "";
