...
{
    [Serializable()]
    public class NailFinDblMit  : SubAssemblyBase
    {
        ...
        public NailFinDblMit()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "TiburAlum-NailFinDblMit ";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(3308, "NailerWidthExt||", this, 1, m_subAssemblyWidth - nailFinRed * 2.0m);
            ...
            decimal p = this.Perimeter + (m_subAssemblyDepth * 4.0m);
