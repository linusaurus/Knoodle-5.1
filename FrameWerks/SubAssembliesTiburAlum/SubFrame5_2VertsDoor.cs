...
{
    [Serializable()]
    public class SubFrame5_2VertsDoor : SubAssemblyBase
    {
        ...
        public SubFrame5_2VertsDoor()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "TiburAlum-SubFrame5_2VertsDoor";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(3076, "SubFrameVert", this, 1, m_subAssemblyHieght - subRedHorz - subRedVert);
