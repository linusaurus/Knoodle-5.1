...
{
    [Serializable()]
    public class Frame_7_Alum_FixedIG : SubAssemblyBase
    {
        ...
        public Frame_7_Alum_FixedIG()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "TiburAlum-Frame_7_Alum_FixedIG";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 4; i++)
            {
                part = new Part(3616, "AlumHorz", this, 1, m_subAssemblyWidth - centerReduce * 2.0m);
