...
{
    [Serializable()]
    public class SubFrame7_2VertSLDoor : SubAssemblyBase
    {
        ...
        public SubFrame7_2VertSLDoor()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "TiburAlum-SubFrame7_2VertSLDoor";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(3074, "SubFrameVert", this, 1, m_subAssemblyHieght - ( 2.0m * subRedHorz) );
