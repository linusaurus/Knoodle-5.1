...
{
    [Serializable()]
    public class SubFrame5_Horz4Mid : SubAssemblyBase
    {
        ...
        public SubFrame5_Horz4Mid()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "TiburAlum-SubFrame5_Horz4Mid";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 8; i++)
            {
                part = new Part(759, "GE SilPruf", this, 1, m_subAssemblyWidth - capReduce );
