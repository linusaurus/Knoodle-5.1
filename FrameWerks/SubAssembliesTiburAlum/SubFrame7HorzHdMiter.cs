...
{
    [Serializable()]
    public class SubFrame7HorzHdMiter : SubAssemblyBase
    {
        ...
        public SubFrame7HorzHdMiter()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "TiburAlum-SubFrame7HorzHdMiter";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 1; i++)
            {
                part = new Part(3074, "SubFrameHorz", this, 1, m_subAssemblyWidth - subRedCnrMit - subRedCnrMit);
