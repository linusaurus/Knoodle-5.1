...
namespace FrameWorks.Makes.TiburAlum
{
    ...
    public class DoorAlumCld_LS_LeadX : SubAssemblyBase
    {
        ...
        public DoorAlumCld_LS_LeadX()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "TiburAlum-DoorAlumCld_LS_LeadX";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 1; i++)
            {
                part = new Part(4094, "ssReinforce1_2", this, 1, m_subAssemblyHieght - ssReinfRed);
                part.PartGroupType = "ssReinforce1_2-Parts";
                part.PartLabel = "";
                m_parts.Add(part);
