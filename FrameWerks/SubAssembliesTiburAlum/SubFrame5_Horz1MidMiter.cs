...
{
    [Serializable()]
    public class SubFrame5_Horz1MidMiter : SubAssemblyBase
    {
        ...
        public SubFrame5_Horz1MidMiter()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "TiburAlum-SubFrame5_Horz1MidMiter";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 1; i++)
            {
                part = new Part(3611, "CapAlumHorzInt90C", this, 1, m_subAssemblyWidth - capHalfReduce - capReMiter);
                part.PartGroupType = "CapAssy-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
                part.PartLabel = "";
            ...
            for (int i = 0; i < 1; i++)
            {
                part = new Part(3611, "CapAlumHorzInt90C", this, 1, m_subAssemblyDepth - capHalfReduce - capReMiter);
                part.PartGroupType = "CapAssy-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
                part.PartLabel = "";
