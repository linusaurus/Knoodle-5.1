...
{
    [Serializable()]
    public class SubFrame7_Horz1Mid : SubAssemblyBase
    {
        ...
        public SubFrame7_Horz1Mid()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "TiburAlum-SubFrame7_Horz1Mid";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 1; i++)
            {
                part = new Part(3074, "SubFrameHorz", this, 1, m_subAssemblyWidth - (subMidRed * 2.0m));
