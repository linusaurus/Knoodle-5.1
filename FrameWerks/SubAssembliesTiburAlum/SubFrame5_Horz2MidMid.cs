...
{
    [Serializable()]
    public class SubFrame5_Horz2MidMid : SubAssemblyBase
    {
        ...
        public SubFrame5_Horz2MidMid()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "TiburAlum-SubFrame5_Horz2MidMid";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(3076, "SubFrameHorz", this, 1, m_subAssemblyWidth - subRedHorz * 2.0m);
            ...
            for (int i = 0; i < 4; i++)
            {
                part = new Part(759, "GE SilPruf", this, 1, m_subAssemblyWidth - capReduce * 2.0m);
