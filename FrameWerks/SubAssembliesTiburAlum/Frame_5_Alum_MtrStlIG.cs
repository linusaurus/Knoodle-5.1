...
{
    [Serializable()]
    public class Frame_5_Alum_MtrStlIG : SubAssemblyBase
    {
        ...
        const decimal glasRdutWide = 3.9175m;
        ...
        public Frame_5_Alum_MtrStlIG()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "TiburAlum-Frame_5_Alum_MtrStlIG";
        }
