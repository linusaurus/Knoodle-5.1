...
namespace FrameWorks.Makes.TiburAlum
{
    ...
    public class Frame_7_Alum_LS_XO : SubAssemblyBase
    {
        ...
        public Frame_7_Alum_LS_XO()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "TiburAlum-Frame_7_Alum_LS_XO";
        }
        ...
        public override void Build()
        {
...

            {
                ...
                for (int i = 0; i < 2; i++)
                {
                    ...
                    part = new Part(3442, "HDMPJamb", this, 1, m_subAssemblyHieght - headReduce);
                    part.PartGroupType = "HDPE-Parts";
                    part.PartLabel = "";
                ...
                for (int i = 0; i < 2; i++)
                {
                    ...
                    part = new Part(3712, "JambAng4Int", this, 1, m_subAssemblyHieght - headReduce);
                ...
                for (int i = 0; i < 2; i++)
                {
                    ...
                    part = new Part(3712, "JambAngExt", this, 1, m_subAssemblyHieght - headReduce);
                    part.PartGroupType = "Frame-Parts";
                    part.PartLabel = "";
                ...
                for (int i = 0; i < 2; i++)
                {
                    ...
                    part = new Part(3711, "HeadAng", this, 1, m_subAssemblyWidth - ( 2.0m * unitReduce));
                    part.PartGroupType = "Frame-Parts";
                    part.PartLabel = "";
