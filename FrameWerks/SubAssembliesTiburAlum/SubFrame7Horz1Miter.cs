...
{
    [Serializable()]
    public class SubFrame7Horz1Miter : SubAssemblyBase
    {
        ...
        public SubFrame7Horz1Miter()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "TiburAlum-SubFrame7Horz1Miter";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 1; i++)
            {
                part = new Part(3074, "SubFrameHorz", this, 1, m_subAssemblyWidth - subRedVert - subRedCnrMit);
            ...
            for (int i = 0; i < 1; i++)
            {
                part = new Part(3074, "SubFrameHorz", this, 1, m_subAssemblyDepth - subRedVert - subRedCnrMit);
                part.PartGroupType = "SubFrameAssy-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
                part.PartLabel = "";
            ...
            for (int i = 0; i < 1; i++)
            {
                part = new Part(3611, "CapAlumHorzExt90B", this, 1, m_subAssemblyWidth);
            ...
            for (int i = 0; i < 1; i++)
            {
                part = new Part(3611, "CapAlumHorzInt90C", this, 1, (m_subAssemblyWidth) - capReMiter * 2);
                part.PartGroupType = "CapAssy-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
                part.PartLabel = "";
