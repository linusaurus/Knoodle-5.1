...
{
    [Serializable()]
    public class SubFrame7_2VertsDoor : SubAssemblyBase
    {
        ...
        public SubFrame7_2VertsDoor()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "TiburAlum-SubFrame7_2VertsDoor";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(3074, "SubFrameVert", this, 1, m_subAssemblyHieght - subRedHorz - subRedVert);
            ...
            for (int i = 0; i < 4; i++)
            {
                part = new Part(3611, "CapAlumVert", this, 1, m_subAssemblyHieght - capReduce );
