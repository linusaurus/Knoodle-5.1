...
{
    [Serializable()]
    public class Frame_7_Alum_AwnMotr : SubAssemblyBase
    {
        ...
        public Frame_7_Alum_AwnMotr()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "TiburAlum-Frame_7_Alum_AwnMotr";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(3617, "AlumHorzInt", this, 1, m_subAssemblyWidth - centerReduce * 2.0m);
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(3617, "AlumVertInt", this, 1, m_subAssemblyHieght - centerReduce * 2.0m);
                part.PartGroupType = "AlumAgl_7_Awning-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
                part.PartLabel = "";
