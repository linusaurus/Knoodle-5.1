...
{
    [Serializable()]
    public class SubFrame7_Caps_Only : SubAssemblyBase
    {
        ...
        public SubFrame7_Caps_Only()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "TiburAlum-SubFrame7_Caps_Only";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 1; i++)
            {
                part = new Part(3611, "CapAlumHorzExt", this, 1, m_subAssemblyWidth);
            ...
            for (int i = 0; i < 1; i++)
            {
                part = new Part(3611, "CapAlumHorzInt", this, 1, m_subAssemblyWidth - capReMiter);
                part.PartGroupType = "CapAssy-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
                part.PartLabel = "";
