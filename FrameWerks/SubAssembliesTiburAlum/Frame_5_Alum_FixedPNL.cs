...
{
    [Serializable()]
    public class Frame_5_Alum_FixedPNL : SubAssemblyBase
    {
        ...
        public Frame_5_Alum_FixedPNL()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "TiburAlum-Frame_5_Alum_FixedPNL";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 4; i++)
            {
                ...
                part.PartGroupType = "AlumAgl_5_FixedPNL-Parts";
            ...
            part = new Part(911);
            part.FunctionalName = "Panel";
            part.PartGroupType = "Alu_Panel-Parts";
            part.Qnty = 1;
