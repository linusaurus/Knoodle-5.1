...
{
    [Serializable()]
    public class SubFrame5_Horz2DblMiter : SubAssemblyBase
    {
        ...
        public SubFrame5_Horz2DblMiter()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "TiburAlum-SubFrame5_Horz2DblMiter";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 4; i++)
            {
                part = new Part(3076, "SubFrameHorz", this, 1, m_subAssemblyDepth - (subRedVert + subRedMiter));
                part.PartGroupType = "SubFrameAssy-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
                part.PartLabel = "";
