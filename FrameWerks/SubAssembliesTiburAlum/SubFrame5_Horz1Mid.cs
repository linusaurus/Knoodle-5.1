...
{
    [Serializable()]
    public class SubFrame5_Horz1Mid : SubAssemblyBase
    {
        ...
        public SubFrame5_Horz1Mid()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "TiburAlum-SubFrame5_Horz1Mid";
        }
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////
            ...
            for (int i = 0; i < 1; i++)
            {
                part = new Part(3076, "SubFrameHorz", this, 1, m_subAssemblyWidth - subMidRed * 2.0m);
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(759, "GE SilPruf", this, 1, m_subAssemblyHieght - capReduce);
