...
{
    [Serializable()]
    public class Frame_7_Alum_MtrStlIG : SubAssemblyBase
    {
        ...
        const decimal capMiteReduce = 0.351483m;
        const decimal cornerCovReduce = 1.12500025m;
        const decimal frameIntRedMiter = 4.0111m;
        const decimal glassReduce = 0.51375m;
        const decimal glasRdutWide = 4.6675m;
        ...
        public Frame_7_Alum_MtrStlIG()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "TiburAlum-Frame_7_Alum_MtrStlIG";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(3616, "AlumHorzExt^>", this, 1, (m_subAssemblyWidth) - (centerReduce) - (capMiteReduce));
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(3616, "AlumHorzInt^>", this, 1, (m_subAssemblyWidth) - (centerReduce) - (frameIntRedMiter));
                part.PartGroupType = "AlumAgl_7_FixedIG-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
            ...
            for (int i = 0; i < 4; i++)
            {
                part = new Part(3616, "AlumVert", this, 1, (m_subAssemblyHieght) - (centerReduce * 2.0m));
                part.PartGroupType = "AlumAgl_7_FixedIG-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
                part.PartLabel = "";
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(3616, "AlumHorzExt^>", this, 1, (m_subAssemblyDepth) - (centerReduce) - (capMiteReduce));
                part.PartGroupType = "AlumAgl_7_FixedIG-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
                part.PartLabel = "HorzExterior^>";
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(3616, "AlumHorzInt^>", this, 1, (m_subAssemblyDepth) - (centerReduce) - (frameIntRedMiter));
                part.PartGroupType = "AlumAgl_7_FixedIG-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
                part.PartLabel = "HorzInterior^>";
