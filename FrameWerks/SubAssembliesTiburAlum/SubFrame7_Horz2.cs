...
namespace FrameWorks.Makes.TiburAlum
{
    ...
    public class SubFrame7_Horz2 : SubAssemblyBase
    {
        ...
        public SubFrame7_Horz2()
        {
            ...
            this.ModelID = "TiburAlum-SubFrame7_Horz2";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(3074, "SubFrameHorz", this, 1, m_subAssemblyWidth - subRedVert * 2.0m);
            ...
            for (int i = 0; i < 4; i++)
            {
                part = new Part(3611, "CapAlumHorz", this, 1, m_subAssemblyWidth - subRedVert * 2.0m);
