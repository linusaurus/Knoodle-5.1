...
using FrameWorks.Makes.Hardware.Amesbury;

namespace FrameWorks.Makes.TiburAlum
{

    public class DoorAlumCldSwingLH : SubAssemblyBase
    {
        ...
        public DoorAlumCldSwingLH()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "TiburAlum-DoorAlumCldSwingLH";
        }
