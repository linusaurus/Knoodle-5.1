...
{
    [Serializable()]
    public class SubFrame7_Horz2Sill : SubAssemblyBase
    {
        ...
        public SubFrame7_Horz2Sill()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "TiburAlum-SubFrame7_Horz2Sill";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(3074, "SubFrameHorz", this, 1, m_subAssemblyWidth + (2.0m * subMidRed));
