...
namespace FrameWorks.Makes.SubAssembliesFASTrcPerft
{
    class FTPXS : SubAssemblyBase
    {
        ...
        public override void Build()
        {
            ...
            Component = new Component(3444, "BladePX", this, 1, (trackHelper.DoorPanelWidth * 2.0m) + doorGap);
            ...
            Component = new Component(3444, "BladePS", this, 1, (trackHelper.DoorPanelWidth * 2.0m) + doorGap);
            Component.ComponentGroupType = "BladeSS-Components";
            Component.ComponentLabel = "";
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                Component = new Component(4424, "PerfecT_PX", this, 1, (trackHelper.DoorPanelWidth * 2.0m) + doorGap);
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                Component = new Component(4424, "PerfecT_PS", this, 1, (trackHelper.DoorPanelWidth * 2.0m) + doorGap);
                Component.ComponentGroupType = "PerfecTack-Components";
                Component.ComponentLabel = "";
