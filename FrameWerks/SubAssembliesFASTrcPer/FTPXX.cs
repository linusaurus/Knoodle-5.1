...
namespace FrameWorks.Makes.SubAssembliesFASTrcPerft
{
    class FTPXX : SubAssemblyBase
    {
        ...
        public override void Build()
        {
            ...
            //BladePX
            Component = new Component(3444, "BladePX", this, 1, (trackHelper.DoorPanelWidth * 2));
            ...
            // BladePXX
            Component = new Component(3444, "BladePXX", this, 1, (trackHelper.DoorPanelWidth * 3) - stileWidth + bladeAdd);
            Component.ComponentGroupType = "BladeSS-Components";
            Component.ComponentLabel = "";
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                Component = new Component(4424, "PerfecT_PX", this, 1, (trackHelper.DoorPanelWidth * 2));
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                Component = new Component(4424, "PerfecT_PXX", this, 1, (trackHelper.DoorPanelWidth * 3) - stileWidth + bladeAdd);
                Component.ComponentGroupType = "PerfecTack-Components";
                Component.ComponentLabel = "";
