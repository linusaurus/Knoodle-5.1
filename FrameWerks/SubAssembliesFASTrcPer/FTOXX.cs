...
namespace FrameWorks.Makes.SubAssembliesFASTrcPerft
{
    class FTOXX : SubAssemblyBase
    {
        ...
        public override void Build()
        {
            ...
            Component = new Component(3444, "BladeOX", this, 1, (trackHelper.DoorPanelWidth * 2.0m) - stileWidth + bladeAdd);
            Component.ComponentGroupType = "BladeSS-Components";
            Component.ComponentLabel = "";
            ...
            Component = new Component(3444, "BladeOXX", this, 1, (trackHelper.DoorPanelWidth * 3.0m) - (2.0m * stileWidth) + (2.0m * bladeAdd));
            Component.ComponentGroupType = "BladeSS-Components";
            Component.ComponentLabel = "";
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                Component = new Component(4424, "PerfecT_OX", this, 1, (trackHelper.DoorPanelWidth * 2.0m) - stileWidth + bladeAdd);
                Component.ComponentGroupType = "PerfecTack-Components";
                Component.ComponentLabel = "";
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                Component = new Component(4424, "PerfecT_OXX", this, 1, (trackHelper.DoorPanelWidth * 3.0m) - (2.0m * stileWidth) + (2.0m * bladeAdd));
                Component.ComponentGroupType = "PerfecTack-Components";
                Component.ComponentLabel = "";
