...
namespace FrameWorks.Makes.SubAssembliesFASTrcPerft
{
    class FTPXXX : SubAssemblyBase
    {
        ...
        public override void Build()
        {
            ...
            //BladePX
            Component = new Component(3444, "BladePX", this, 1, (trackHelper.DoorPanelWidth * 2) - pocketInset);
            ...
            // BladePXX
            Component = new Component(3444, "BladePXX", this, 1, (trackHelper.DoorPanelWidth * 3) - stileWidth - pocketInset);
            Component.ComponentGroupType = "BladeSS-Components";
            Component.ComponentLabel = "";
            ...
            // BladePXXX
            Component = new Component(3444, "BladePXXX", this, 1, (trackHelper.DoorPanelWidth * 4) - (2 * stileWidth) - pocketInset + bladeAdd);
            Component.ComponentGroupType = "BladeSS-Components";
            Component.ComponentLabel = "";
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                Component = new Component(4424, "PerfecT_PX", this, 1, (trackHelper.DoorPanelWidth * 2) - pocketInset);
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                Component = new Component(4424, "PerfecT_PXX", this, 1, (trackHelper.DoorPanelWidth * 3) - stileWidth - pocketInset);
                Component.ComponentGroupType = "PerfecTack-Components";
                Component.ComponentLabel = "";
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                Component = new Component(4424, "PerfecT_PXXX", this, 1, (trackHelper.DoorPanelWidth * 4) - (2 * stileWidth) - pocketInset + bladeAdd);
                Component.ComponentGroupType = "PerfecTack-Components";
                Component.ComponentLabel = "";
