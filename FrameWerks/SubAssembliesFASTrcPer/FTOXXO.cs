...
namespace FrameWorks.Makes.SubAssembliesFASTrcPerft
{
    class FTOXXO : SubAssemblyBase
    {
        ...
        public override void Build()
        {
            ...
            // BladeXX
            Component = new Component(3444, "BladeXX", this, 1, m_subAssemblyWidth);
            Component.ComponentGroupType = "BladeSS-Components";
            Component.ComponentLabel = "";
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                Component = new Component(4424, "PerfecT_LftO", this, 1, (trackHelper.DoorPanelWidth + jambAdjust) / 2.0m);
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                Component = new Component(4424, "PerfecT_RhtO", this, 1, (trackHelper.DoorPanelWidth + jambAdjust) / 2.0m);
                Component.ComponentGroupType = "PerfecTack-Components";
                Component.ComponentLabel = "";
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                Component = new Component(4424, "PerfecT_XX", this, 1, m_subAssemblyWidth);
                Component.ComponentGroupType = "PerfecTack-Components";
                Component.ComponentLabel = "";
