...
namespace FrameWorks.Makes.SubAssembliesFASTrcPerft
{
    class FTPXXXXX : SubAssemblyBase
    {
        ...
        public override void Build()
        {
            ...
            //BladePX
            Component = new Component(3444, "BladePX", this, 1, trackHelper.DoorPanelWidth * 2 - jambInset);
            ...
            // BladePXX
            Component = new Component(3444, "BladePXX", this, 1, trackHelper.DoorPanelWidth * 3 - stileWidth - jambInset);
            Component.ComponentGroupType = "BladeSS-Components";
            Component.ComponentLabel = "";
            ...
            // BladePXXX
            Component = new Component(3444, "BladePXXX", this, 1, trackHelper.DoorPanelWidth * 4 - stileWidth * 2 - jambInset);
            Component.ComponentGroupType = "BladeSS-Components";
            Component.ComponentLabel = "";
            ...
            // BladePXXXX
            Component = new Component(3444, "BladePXXXX", this, 1, trackHelper.DoorPanelWidth * 5 - stileWidth * 3 - jambInset);
            Component.ComponentGroupType = "BladeSS-Components";
            Component.ComponentLabel = "";
            ...
            // BladePXXXXX
            Component = new Component(3444, "BladePXXXXX", this, 1, trackHelper.DoorPanelWidth * 6 - stileWidth * 4 - jambInset + doorGap + jambThick);
            Component.ComponentGroupType = "BladeSS-Components";
            Component.ComponentLabel = "";
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                Component = new Component(4424, "PerfecT_PX", this, 1, trackHelper.DoorPanelWidth * 2 - jambInset);
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                Component = new Component(4424, "PerfecT_PXX", this, 1, trackHelper.DoorPanelWidth * 3 - stileWidth - jambInset);
                Component.ComponentGroupType = "PerfecTack-Components";
                Component.ComponentLabel = "";
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                Component = new Component(4424, "PerfecT_PXXX", this, 1, trackHelper.DoorPanelWidth * 4 - stileWidth * 2 - jambInset);
                Component.ComponentGroupType = "PerfecTack-Components";
                Component.ComponentLabel = "";
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                Component = new Component(4424, "PerfecT_PXXXX", this, 1, trackHelper.DoorPanelWidth * 5 - stileWidth * 3 - jambInset);
                Component.ComponentGroupType = "PerfecTack-Components";
                Component.ComponentLabel = "";
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                Component = new Component(4424, "PerfecT_OXXXX", this, 1, trackHelper.DoorPanelWidth * 6 - stileWidth * 4 - jambInset + doorGap + jambThick);
                Component.ComponentGroupType = "PerfecTack-Components";
                Component.ComponentLabel = "";
