    ...
    class FTPXXXXP : SubAssemblyBase
    {
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 4; i++)
            {
                ...
                Component = new Component(4424, "PerfecT_PX", this, 1, m_subAssemblyWidth / 2.0m - centGapHlf + stileWidth);
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                Component = new Component(4424, "PerfecT_PXX", this, 1, m_subAssemblyWidth + (m_subAssemblyWidth / 2.0m + stileWidth + centGapHlf));
                Component.ComponentGroupType = "PerfecTack-Components";
                Component.ComponentLabel = "";
