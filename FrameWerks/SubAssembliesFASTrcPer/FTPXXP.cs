...
namespace FrameWorks.Makes.SubAssembliesFASTrcPerft
{
    class FTPXXP : SubAssemblyBase
    {
        ...
        public override void Build()
        {
            ...
            // BladePXXP
            Component = new Component(3444, "BladePXXP", this, 1, (trackHelper.DoorPanelWidth * 2));
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                Component = new Component(4424, "PerfecT_O", this, 1, (trackHelper.DoorPanelWidth * 2));
            ...
            Component = new Component(5435, "BridgeClipsPoc", this, trackHelper.BridgeCount * 2, 0.0m);
            Component.ComponentGroupType = "PocBrdgAssY-Components";
            Component.ComponentLabel = "";
            ...
            Component = new Component(5433, "NutPlateConPoc", this, (trackHelper.BridgeCount) * (panelCount), 0.0m);
            Component.ComponentGroupType = "PocBrdgAssY-Components";
            Component.ComponentLabel = "";
