...
namespace FrameWorks.Makes.System3340
{
    ...
    public class FixedFloor_1x2 : SubAssemblyBase
    {
        ...
        public FixedFloor_1x2()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System3340-FixedFloor_1x2";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 1; i++)
            {
                part = new Part(4414, "Fixed_4414_Hd", this, 1, m_subAssemblyWidth);
                part.PartGroupType = "FrameBrz-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
                part.PartLabel = "";
            ...
            for (int i = 0; i < 4; i++)
            {
                part = new Part(4413, "GlsStp_4413_Vt", this, 1, (m_subAssemblyHieght - (stopReduce + stopReduceBOT + muntinNibX1)) / 2.0m);
