...
namespace FrameWorks.Makes.System3340
{
    ...
    public class CasementRHR_1x4 : SubAssemblyBase
    {
        ...
        public CasementRHR_1x4()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System3340-CasementRHR_1x4";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(4413, "GlsStp_4413_Vt", this, 1, (m_subAssemblyHieght - (stopReduceX2 + muntinNibX3)) / 4.0m - 0.703125m);
            ...
            for (int i = 0; i < 6; i++)
            {
                part = new Part(4413, "GlsStp_4413_Vt", this, 1, (m_subAssemblyHieght - (stopReduceX2 + muntinNibX3)) / 4.0m + 0.23475m);
                part.PartGroupType = "StopBrz1x4-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
