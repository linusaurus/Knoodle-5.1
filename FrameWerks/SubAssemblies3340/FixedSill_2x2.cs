...
namespace FrameWorks.Makes.System3340
{
    ...
    public class FixedSill_2x2 : SubAssemblyBase
    {
        ...
        const decimal muntinWidth = 1.5m;
        ...
        public FixedSill_2x2()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System3340-FixedSill_2x2";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 8; i++)
            {
                part = new Part(4413, "GlsStp_4413_Vt", this, 1, (m_subAssemblyHieght - stopReduceX2 - muntinNibX1) / 2.0m);
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(4423, "MuntinVt_4423_Int", this, 1, (m_subAssemblyHieght - stopReduceX2) / 2.0m);
                part.PartGroupType = "Muntin-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
                part.PartLabel = "BishopsMiter";
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(4423, "MuntHz_4423_Int", this, 1, (m_subAssemblyWidth - stopReduceX2) / 2.0m);
                part.PartGroupType = "Muntin-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
                part.PartLabel = "BishopsMiter";
            ...
            for (int i = 0; i < 1; i++)
            {
                part = new Part(4418, "MuntHz_4418_Ext", this, 1, m_subAssemblyWidth - muntinReduceX2);
                part.PartGroupType = "Muntin-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
                part.PartLabel = "";
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(4418, "MuntVt_4418_Ext", this, 1, (m_subAssemblyHieght - muntinReduceX2 - muntinWidth) / 2.0m);
                part.PartGroupType = "Muntin-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
                part.PartLabel = "";
