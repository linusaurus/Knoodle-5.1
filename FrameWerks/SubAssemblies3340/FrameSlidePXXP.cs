...
namespace FrameWorks.Makes.System3340
{
    ...
    public class FrameSlidePXXP : SubAssemblyBase
    {
        ...
        public FrameSlidePXXP()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System3340-FrameSlidePXXP";
        }
        ...
        public override void Build()
        {
            ...
            // TopTrackYOX
            part = new Part(4447, "TopTrackYX", this, 1, (trackHelper.DoorPanelWidth * 2.0m) - reducHDPE - jambInset2X + pockYtrackAdd2X + doorGap2X);
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                part = new Part(4364, "Facia_4364_Hd", this, 1, m_subAssemblyWidth - jambDimW - jambDimW);
                part.PartGroupType = "Frame-Parts";
                part.PartLabel = "";
            ...
            // HDPEHead ^^
            part = new Part(3454, "HDPE_Head", this, 1, trackHelper.DoorPanelWidth * 2.0m - reducHDPE - jambInset2X + pockYtrackAdd2X + doorGap2X);
            part.PartGroupType = "Frame-Parts";
