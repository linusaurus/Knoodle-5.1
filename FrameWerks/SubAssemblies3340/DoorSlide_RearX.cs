...
namespace FrameWorks.Makes.System3340
{
    ...
    public class DoorSlide_RearX : SubAssemblyBase
    {
        ...
        public DoorSlide_RearX()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System3340-DoorSlide_RearX";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 1; i++)
            {
                part = new Part(911, "TurdOnRearStile", this, 1, m_subAssemblyHieght);
                part.PartGroupType = "CloseOut";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
                part.PartLabel = "TurdOnRearStile";
            ...
            for (int i = 0; i < 1; i++)
            {
                part = new Part(911, "BigBlockTurd", this, 1, m_subAssemblyHieght);
                part.PartGroupType = "BigBlockTurd";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
                part.PartLabel = "BigBlockTurd";
            ...
            for (int i = 0; i < 1; i++)
            {
                part = new Part(911, "SheetMetalTurd", this, 1, m_subAssemblyHieght);
                part.PartGroupType = "CloseOut";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
                part.PartLabel = "SheetMetalTurd";
