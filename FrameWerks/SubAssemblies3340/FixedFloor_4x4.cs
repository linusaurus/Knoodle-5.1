...
namespace FrameWorks.Makes.System3340
{
    ...
    public class FixedFloor_4x4 : SubAssemblyBase
    {
        ...
        public FixedFloor_4x4()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System3340-FixedFloor_4x4";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 8; i++)
            {
                part = new Part(4413, "GlsStp_4413_Vt", this, 1, (m_subAssemblyHieght - (stopReduce + stopReduceBOT + muntinNibX3)) / 4.0m);
            ...
            for (int i = 0; i < 8; i++)
            {
                part = new Part(4413, "GlsStp_4413_Horz", this, 1, (m_subAssemblyWidth - (stopReduceX2 + muntinNibX3)) / 4.0m);
                part.PartGroupType = "StopBrz-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
                part.PartLabel = "";
