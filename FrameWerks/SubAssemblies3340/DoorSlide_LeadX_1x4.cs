...
namespace FrameWorks.Makes.System3340
{
    ...
    public class DoorSlide_LeadX_1x4 : SubAssemblyBase
    {
        ...
        public DoorSlide_LeadX_1x4()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System3340-DoorSlide_LeadX_1x4";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 8; i++)
            {
                part = new Part(4413, "GlsStp_4413_Vt", this, 1, (m_subAssemblyHieght - (stopReduceX2 + muntinNibX3)) / 4.0m);
