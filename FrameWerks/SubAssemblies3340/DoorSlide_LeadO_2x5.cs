...
namespace FrameWorks.Makes.System3340
{
    ...
    public class DoorSlide_LeadO_2x5 : SubAssemblyBase
    {
        ...
        const decimal muntinNib = 0.125m;
        ...
        public DoorSlide_LeadO_2x5()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System3340-DoorSlide_LeadO_2x5";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 1; i++)
            {
                part = new Part(4423, "Munt_Vt_4423_Int", this, 1, m_subAssemblyHieght - stopReduceX2);
            ...
            for (int i = 0; i < 1; i++)
            {
                part = new Part(4418, "Munt_Vt_4418_Ext", this, 1, m_subAssemblyHieght - muntinReduceX2);
                part.PartGroupType = "MuntinBars-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
                part.PartLabel = "2x5";
