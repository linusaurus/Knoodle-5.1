...
namespace FrameWorks.Makes.System3340
{
    ...
    public class DoorBfoldJmbL: SubAssemblyBase
    {
        ...
        public DoorBfoldJmbL()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System3340-DoorBfoldJmbL";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(4413, "GlsStpVt", this, 1, m_subAssemblyHieght - stopReduceX2);
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(4413, "GlsStpHorz", this, 1, m_subAssemblyWidth - stopReduceX2);
                part.PartGroupType = "StopBrz-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
                part.PartLabel = "";
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                part = new Part(911, "BotPileSeal", this, 1, m_subAssemblyWidth);
                part.PartGroupType = "Seal-Parts";
