...
namespace FrameWorks.Makes.System3340
{
    ...
    public class DoorSlide_MidX : SubAssemblyBase
    {
        ...
        const decimal fecal_matter_Bracket = 2.2813m;
        ...
        public DoorSlide_MidX()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System3340-DoorSlide_MidX";
        }
        ...
        public override void Build()
        {
            ...
            // fecal_matter_Bracket
            for (int i = 0; i < 1; i++)
            {
                part = new Part(911, "fecal_matter_Bracket", this, 1, fecal_matter_Bracket);
                part.PartGroupType = "Hardware-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
                part.PartLabel = "fecal_matter_Bracket";
