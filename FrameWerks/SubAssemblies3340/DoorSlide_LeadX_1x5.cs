...
namespace FrameWorks.Makes.System3340
{
    ...
    public class DoorSlide_LeadX_1x5 : SubAssemblyBase
    {
        ...
        const decimal muntinNibX4 = 1.5m * 4.0m;
        ...
        public DoorSlide_LeadX_1x5()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System3340-DoorSlide_LeadX_1x5";
        }
        ...
        public override void Build()
        {
            ...
            part.ContainerAssembly = this;
            part.PartWidth = m_subAssemblyWidth - (glassReduceX2);
            part.PartLength = 84.7375m;
            part.PartThick = 0.53125m;
            part.PartLabel = "Lower_ACID_ETCHED";
