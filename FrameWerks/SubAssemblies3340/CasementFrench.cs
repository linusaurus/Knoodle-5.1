...
namespace FrameWorks.Makes.System3340
{
    ...
    public class CasementFrench : SubAssemblyBase
    {
        ...
        public CasementFrench()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System3340-CasementFrench";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                part = new Part(2995, "SupportBlock_R_L", this, 1, 0.0m);
                part.PartGroupType = "FrameHardware-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
                part.PartLabel = "";
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(4416, "Sash_4416_Vert_Rt", this, 1, m_subAssemblyHieght - sashReduceX2);
                part.PartGroupType = "Sash-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
                part.PartLabel = "French";
            ...
            for (int i = 0; i < 1; i++)
            {
                part = new Part(4416, "Sash_4416_Vert_Lft", this, 1, m_subAssemblyHieght - sashReduceX2);
                part.PartGroupType = "Sash-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
                part.PartLabel = "French";
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(4416, "Sash_4416_Horz_Rt", this, 1, (m_subAssemblyWidth - sashReduceX2) / 2.0m + sashFrenchAdd);
                part.PartGroupType = "Sash-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
                part.PartLabel = "French";
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(4416, "Sash_4416_Horz_Lft", this, 1, (m_subAssemblyWidth - sashReduceX2) / 2.0m + sashFrenchAdd);
                part.PartGroupType = "Sash-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
                part.PartLabel = "French";
            ...
            for (int i = 0; i < 4; i++)
            {
                part = new Part(4413, "GlsStp_4413_Hz", this, 1, (m_subAssemblyWidth - stopReduceX2 - stopRedFrench) / 2.0m);
                part.PartGroupType = "StopBrz-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
                part.PartLabel = "";
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                part.PartWidth = (m_subAssemblyWidth - glassReduceX2 - glassReducMid) / 2.0m ;
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                decimal peri = FrameWorks.Functions.Perimeter(m_subAssemblyHieght - gasketReduce, (m_subAssemblyWidth / 2.0m) );
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                decimal peri = FrameWorks.Functions.Perimeter(m_subAssemblyHieght - windGrdRed, (m_subAssemblyWidth / 2.0m));
