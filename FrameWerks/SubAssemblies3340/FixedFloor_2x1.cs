...
namespace FrameWorks.Makes.System3340
{
    ...
    public class FixedFloor_2x1 : SubAssemblyBase
    {

        #region Fields

        //Constant Values
        const decimal sillReduce = 1.9375m;
        ...
        const decimal muntinNibX1 = 1.50m * 1.0m;
        const decimal muntinReduceX1 = 1.3125m * 1.0m;
        ...
        public FixedFloor_2x1()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System3340-FixedFloor_2x1";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(4414, "Fixed_4414_Vt", this, 1, m_subAssemblyHieght - stopReduce);
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(4413, "GlsStp_4413_Vt", this, 1, m_subAssemblyHieght - stopReduce - stopReduceBOT);
            ...
            for (int i = 0; i < 4; i++)
            {
                part = new Part(4413, "GlsStp_4413_Hz", this, 1, (m_subAssemblyWidth - (stopReduceX2 + muntinNibX1)) / 2.0m);
                part.PartGroupType = "StopBrz-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
                part.PartLabel = "";
            ...
            for (int i = 0; i < 1; i++)
            {
                part = new Part(4423, "Muntin_4423_Int", this, 1, m_subAssemblyHieght - stopReduce - stopReduceBOT);
            ...
            for (int i = 0; i < 1; i++)
            {
                part = new Part(4418, "Muntin_4418_Ext", this, 1, m_subAssemblyHieght - muntinReduceX1 - sillReduce);
                part.PartGroupType = "Muntin-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
                part.PartLabel = "";
            ...
            for (int i = 0; i < 1; i++)
            {
                ...
                decimal peri = FrameWorks.Functions.Perimeter(m_subAssemblyHieght - stopReduce - gasketReduce, m_subAssemblyWidth - gasketReduce);
