...
namespace FrameWorks.Makes.System3340
{
    ...
    public class FixedSillsr_1x5 : SubAssemblyBase
    {

        #region Fields

        //Constant Values
        const decimal steelMulRed = 0.40625m;
        ...
        public FixedSillsr_1x5()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System3340-FixedSillsr_1x5";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(4414, "Fixed_4414_HdSill", this, 1, m_subAssemblyWidth);
                part.PartGroupType = "FrameBrz-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
                part.PartLabel = "";
            ...
            part.PartLength = 71.775m - glassReduce - steelMulRed;
            part.PartThick = 0.53125m;
            part.PartLabel = "Lower1x5";
            ...
            part.ContainerAssembly = this;
            part.PartWidth = m_subAssemblyWidth - (glassReduceX2);
            part.PartLength = 48.0375m - glassReduce - steelMulRed;
            part.PartThick = 0.53125m;
            part.PartLabel = "Upper1x5";
