...
namespace DataLayer.Data
{
    public partial class MosaicContext : DbContext
    {
        ...
        public virtual DbSet<BOMListItem> BOMListItems { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=192.168.10.51;database=Mosaic;uid=sa;pwd=Kx09a32x", x => x.UseNetTopologySuite());
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<PrintOrder>(entity =>
            {
                ...
                entity.Property(e => e.Extended).HasColumnType("decimal(18, 4)");
                ...
                entity.Property(e => e.Qnty).HasColumnType("decimal(18, 4)");
